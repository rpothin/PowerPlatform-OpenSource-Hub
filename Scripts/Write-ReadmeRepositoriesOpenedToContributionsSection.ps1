function Write-ReadmeRepositoriesOpenedToContributionsSection {
    ...
    Process {
        ...
        $repositoriesOpenedToContributionsPrepared = $repositoriesOpenedToContributionsSorted | Select-Object `
            ...
            @{Name="Good First Issues";Expression={New-ShieldIoBadge -AlternativeText "Good First Issues Badge" -Message "Good First Issues" -Label $_.openedGoodFirstIssues -Color "green" -OutputFormat "Markdown"}}, `
            @{Name="Help Wanted Issues";Expression={New-ShieldIoBadge -AlternativeText "Help Wanted Issues Badge" -Message "Help Wanted Issues" -Label $_.openedHelpWantedIssues -Color "blue" -OutputFormat "Markdown"}}, `
