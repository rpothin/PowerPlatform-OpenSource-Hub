...
<section class="mdx-detail-hero">
  <h1>powerplatform-vscode-lab</h1>
  <p class="mdx-detail-hero__description">Hands-on lab for Power Platform Tools for Visual Studio Code</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/powerplatform-vscode-lab" class="md-button md-button--primary" target="_blank" rel="noopener">
