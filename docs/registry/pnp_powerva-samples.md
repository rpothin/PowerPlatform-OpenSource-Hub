...
<section class="mdx-detail-hero">
  <h1>powerva-samples</h1>
  <p class="mdx-detail-hero__description">Contains curated community samples for Microsoft Power Virtual Agents</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/pnp/powerva-samples" class="md-button md-button--primary" target="_blank" rel="noopener">
