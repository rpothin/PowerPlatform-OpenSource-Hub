...
<section class="mdx-detail-hero">
  <h1>powerplatform-cli-wrapper</h1>
  <p class="mdx-detail-hero__description">Power Platform CLI Wrapper</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/powerplatform-cli-wrapper" class="md-button md-button--primary" target="_blank" rel="noopener">
