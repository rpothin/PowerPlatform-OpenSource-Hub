...
<section class="mdx-detail-hero">
  <h1>TACO</h1>
  <p class="mdx-detail-hero__description">Microsoft Teams AA/CQ Orchestrator (TACO) App</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OfficeDev/TACO" class="md-button md-button--primary" target="_blank" rel="noopener">
