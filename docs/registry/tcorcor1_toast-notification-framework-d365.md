...
<section class="mdx-detail-hero">
  <h1>toast-notification-framework-D365</h1>
  <p class="mdx-detail-hero__description">Creating a framework around the in-app/toast notification feature provided by the Dynamics 365 SDK </p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/tcorcor1/toast-notification-framework-D365" class="md-button md-button--primary" target="_blank" rel="noopener">
