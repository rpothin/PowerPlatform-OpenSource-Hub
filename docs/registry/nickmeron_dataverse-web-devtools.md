...
<section class="mdx-detail-hero">
  <h1>Dataverse-Web-Devtools</h1>
  <p class="mdx-detail-hero__description">A modern, browser-based developer toolkit for Microsoft Dataverse — replaces the legacy Plugin Registration Tool</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/nickmeron/Dataverse-Web-Devtools" class="md-button md-button--primary" target="_blank" rel="noopener">
