...
<section class="mdx-detail-hero">
  <h1>fscps</h1>
  <p class="mdx-detail-hero__description">D365 FSC DevOps setup&maintenance tools for GitHub</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/fscpscollaborative/fscps" class="md-button md-button--primary" target="_blank" rel="noopener">
