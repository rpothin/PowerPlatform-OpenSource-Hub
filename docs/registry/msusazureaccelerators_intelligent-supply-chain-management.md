...
<section class="mdx-detail-hero">
  <h1>Intelligent-Supply-Chain-Management</h1>
  <p class="mdx-detail-hero__description">The Supply Chain Management Accelerator leverages deep learning forecasts, Azure Machine Learning and distributed computing with a Ray Cluster, to simulate an inventory optimization problem using synthetic data. It allows you to also run other simulations, using a PowerApps user-interface connected directly to the Azure Kubernetes Instance running </p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MSUSAzureAccelerators/Intelligent-Supply-Chain-Management" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2023-05-19</span>
    <span>Updated 2025-09-02</span>
  </div>
</section>
