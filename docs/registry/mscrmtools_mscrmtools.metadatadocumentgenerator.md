...
<section class="mdx-detail-hero">
  <h1>MsCrmTools.MetadataDocumentGenerator</h1>
  <p class="mdx-detail-hero__description">An XrmToolBox plugin to generate Excel documentation with CRM metadata</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MscrmTools/MsCrmTools.MetadataDocumentGenerator" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2018-04-24</span>
    <span>Updated 2025-11-13</span>
  </div>
</section>
