...
<section class="mdx-detail-hero">
  <h1>microsoft-teams-apps-requestateam</h1>
  <p class="mdx-detail-hero__description">Power Platform based solution that allows users to request teams and automates team creation. NO LONGER MAINTAINED. Please use 'Provision Assist' - https://github.com/pnp/provision-assist-m365/ instead.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OfficeDev/microsoft-teams-apps-requestateam" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 239</div>
    <div class="mdx-detail-stats__label">Stars</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">👁️ 44</div>
    <div class="mdx-detail-stats__label">Watchers</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 64</div>
    <div class="mdx-detail-stats__label">Forks</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 138</div>
