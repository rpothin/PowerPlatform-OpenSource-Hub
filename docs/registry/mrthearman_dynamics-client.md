...
<section class="mdx-detail-hero">
  <h1>dynamics-client</h1>
  <p class="mdx-detail-hero__description">Client for making Web API request from a Microsoft Dynamics 365 Database</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MrThearMan/dynamics-client" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2021-05-09</span>
    <span>Updated 2026-04-01</span>
    <span><a href="https://pypi.org/project/dynamics-client/" target="_blank" rel="noopener">https://pypi.org/project/dynamics-client/</a></span>
  </div>
</section>
