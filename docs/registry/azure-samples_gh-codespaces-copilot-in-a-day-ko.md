...
<section class="mdx-detail-hero">
  <h1>gh-codespaces-copilot-in-a-day-ko</h1>
  <p class="mdx-detail-hero__description">GitHub Codespaces & Copilot 핸즈온 워크샵 리포지토리입니다</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Azure-Samples/gh-codespaces-copilot-in-a-day-ko" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2023-04-09</span>
    <span>Updated 2025-07-19</span>
  </div>
</section>
