...
<section class="mdx-detail-hero">
  <h1>xrm-mock</h1>
  <p class="mdx-detail-hero__description">:books: A fake implementation of the Xrm object model. Written in TypeScript against @types/xrm definitions.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/davidjbclark/xrm-mock" class="md-button md-button--primary" target="_blank" rel="noopener">
