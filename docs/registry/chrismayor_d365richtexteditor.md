...
<section class="mdx-detail-hero">
  <h1>D365RichTextEditor</h1>
  <p class="mdx-detail-hero__description">Dynamics 365 Rich text editor for Unified Interface / Based on PowerApps component framework, React and quill</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ChrisMayor/D365RichTextEditor" class="md-button md-button--primary" target="_blank" rel="noopener">
