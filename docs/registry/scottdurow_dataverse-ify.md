...
<section class="mdx-detail-hero">
  <h1>dataverse-ify</h1>
  <p class="mdx-detail-hero__description">Easily call the Dataverse WebApi from TypeScript using SDK style types, with a NodeJS implementation for integration testing.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/scottdurow/dataverse-ify" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 73</div>
