...
<section class="mdx-detail-hero">
  <h1>JM-Dataverse-Toolbelt</h1>
  <p class="mdx-detail-hero__description">App and Visual Studio Extension for Microsoft Dynamics for CE and PowerApps Common Data Service</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/josephmcmac/JM-Dataverse-Toolbelt" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>C#</span>
    <span>None</span>
    <span>Created 2015-05-04</span>
    <span>Updated 2025-07-21</span>
    <span><a href="https://josephmcmac.wordpress.com" target="_blank" rel="noopener">https://josephmcmac.wordpress.com</a></span>
  </div>
</section>
