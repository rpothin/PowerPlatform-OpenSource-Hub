...
<section class="mdx-detail-hero">
  ...
  <p class="mdx-detail-hero__description">The easiest way to connect Dynamics 365 with WordPress.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/AlexaCRM/integration-dynamics" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>PHP</span>
    <span>GNU General Public License v2.0</span>
    <span>Created 2016-09-30</span>
    <span>Updated 2026-01-04</span>
  </div>
</section>
