...
<section class="mdx-detail-hero">
  <h1>PowerApps-Azure-Lab</h1>
  <p class="mdx-detail-hero__description">Repository to host the PowerApps Azure Lab</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/PowerApps-Azure-Lab" class="md-button md-button--primary" target="_blank" rel="noopener">
