...
<section class="mdx-detail-hero">
  <h1>powerplatform</h1>
  <p class="mdx-detail-hero__description">The official repository for Power Platform tools and resources.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/powerplatform" class="md-button md-button--primary" target="_blank" rel="noopener">
