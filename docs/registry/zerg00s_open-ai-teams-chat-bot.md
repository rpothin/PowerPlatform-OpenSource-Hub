...
<section class="mdx-detail-hero">
  <h1>open-ai-teams-chat-bot</h1>
  <p class="mdx-detail-hero__description">This Github repository contains two Power Automate flows that use OpenAI to answer questions in Teams. One flow uses the Standalone OpenAI service, while the other uses Azure OpenAI.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Zerg00s/open-ai-teams-chat-bot" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>Unknown</span>
    <span>None</span>
    <span>Created 2023-02-19</span>
    <span>Updated 2025-10-25</span>
  </div>
</section>
