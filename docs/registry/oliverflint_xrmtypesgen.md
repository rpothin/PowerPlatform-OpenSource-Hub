...
<section class="mdx-detail-hero">
  <h1>XrmTypesGen</h1>
  <p class="mdx-detail-hero__description">A Typescript Type Declaration Generator for Dynamics 365</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OliverFlint/XrmTypesGen" class="md-button md-button--primary" target="_blank" rel="noopener">
