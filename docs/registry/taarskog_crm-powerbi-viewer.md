...
<section class="mdx-detail-hero">
  <h1>crm-powerbi-viewer</h1>
  <p class="mdx-detail-hero__description">Embed tiles and reports from Power BI into Dynamics CRM Forms and Dashboards.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/taarskog/crm-powerbi-viewer" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2016-02-26</span>
    <span>Updated 2025-05-22</span>
    <span><a href="http://crm-powerbi-viewer.heiigjen.com/" target="_blank" rel="noopener">http://crm-powerbi-viewer.heiigjen.com/</a></span>
  </div>
</section>
