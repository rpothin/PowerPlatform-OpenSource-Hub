...
<section class="mdx-detail-hero">
  <h1>Stock-Templates-Remastered</h1>
  <p class="mdx-detail-hero__description">Microsoft Power Apps has several stock templates. We'll dust them off and make sure each of them function properly.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/PowerAppsDarren/Stock-Templates-Remastered" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2024-12-06</span>
    <span>Updated 2026-02-13</span>
    <span><a href="https://whop.com/learn-power-apps/" target="_blank" rel="noopener">https://whop.com/learn-power-apps/</a></span>
  </div>
</section>
