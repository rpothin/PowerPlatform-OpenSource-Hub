...
<section class="mdx-detail-hero">
  ...
  <p class="mdx-detail-hero__description">Publicly released versions of Power Automate for desktop</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/jfevia/Power-Automate-Desktop" class="md-button md-button--primary" target="_blank" rel="noopener">
