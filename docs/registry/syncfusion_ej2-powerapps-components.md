...
<section class="mdx-detail-hero">
  <h1>ej2-powerapps-components</h1>
  <p class="mdx-detail-hero__description">This repository features Syncfusion PowerApps components built using the PowerApps Component Framework (PCF). These components offer rich UI elements such as Data Grids, Charts, Schedules, and more, designed to enhance the functionality and flexibility of PowerApps applications.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/syncfusion/ej2-powerapps-components" class="md-button md-button--primary" target="_blank" rel="noopener">
