...
<section class="mdx-detail-hero">
  <h1>SharePointWorkflowConverter</h1>
  <p class="mdx-detail-hero__description">A proof-of-concept C# console application for retrieving legacy 2010 & 2013 custom SharePoint workflow definition files, and creating new Power Automate flows programmatically.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Dev-Mom/SharePointWorkflowConverter" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>C#</span>
    <span>None</span>
    <span>Created 2020-09-15</span>
    <span>Updated 2025-12-08</span>
  </div>
</section>
