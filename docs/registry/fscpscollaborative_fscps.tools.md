...
<section class="mdx-detail-hero">
  <h1>fscps.tools</h1>
  <p class="mdx-detail-hero__description">A set of tools for maintaining D365FSC CI/CD pipelines.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/fscpscollaborative/fscps.tools" class="md-button md-button--primary" target="_blank" rel="noopener">
