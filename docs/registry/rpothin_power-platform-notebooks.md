...
<section class="mdx-detail-hero">
  <h1>Power-Platform-Notebooks</h1>
  <p class="mdx-detail-hero__description">Notebook templates for support, administration, learning, training... related to Power Platform.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rpothin/Power-Platform-Notebooks" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2022-07-24</span>
    <span>Updated 2024-03-23</span>
  </div>
</section>
