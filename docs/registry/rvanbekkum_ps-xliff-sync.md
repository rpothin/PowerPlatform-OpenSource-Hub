...
<section class="mdx-detail-hero">
  <h1>ps-xliff-sync</h1>
  <p class="mdx-detail-hero__description">A PowerShell module to synchronize and validate XLIFF translation files.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rvanbekkum/ps-xliff-sync" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-08-28</span>
    <span>Updated 2026-03-19</span>
    <span><a href="https://www.powershellgallery.com/packages/XliffSync" target="_blank" rel="noopener">https://www.powershellgallery.com/packages/XliffSync</a></span>
  </div>
</section>
