...
<section class="mdx-detail-hero">
  <h1>global-copilot-summit</h1>
  <p class="mdx-detail-hero__description">The theme of the summit is Adopt, Extend, and Build Copilot, and is attended by professional developers interested in learning more about AI, GitHub Copilot, Azure AI Studio, or Power Apps and how they can leverage them with M365 Copilot. </p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/global-copilot-summit" class="md-button md-button--primary" target="_blank" rel="noopener">
