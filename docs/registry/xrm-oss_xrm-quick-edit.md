...
<section class="mdx-detail-hero">
  <h1>Xrm-Quick-Edit</h1>
  <p class="mdx-detail-hero__description">A Dynamics CRM Add-In for speeding up tasks such as translating or toggling field security on or off</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/XRM-OSS/Xrm-Quick-Edit" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2017-01-15</span>
    <span>Updated 2025-12-31</span>
  </div>
</section>
