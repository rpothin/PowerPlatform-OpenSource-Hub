...
<section class="mdx-detail-hero">
  <h1>playwright-azure-ad-mfa</h1>
  <p class="mdx-detail-hero__description">Sample repo to demonstrate how to use MFA with Azure AD auth</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rajyraman/playwright-azure-ad-mfa" class="md-button md-button--primary" target="_blank" rel="noopener">
