...
<section class="mdx-detail-hero">
  <h1>pcf-fluentui-grid</h1>
  <p class="mdx-detail-hero__description">Fluent UI DataList Component for D365/PowerApps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/michal-turzynski/pcf-fluentui-grid" class="md-button md-button--primary" target="_blank" rel="noopener">
