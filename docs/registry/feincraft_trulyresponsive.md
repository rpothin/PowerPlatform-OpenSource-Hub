...
<section class="mdx-detail-hero">
  <h1>TrulyResponsive</h1>
  <p class="mdx-detail-hero__description">TrulyResponsive is the framework to build PowerApps that show the right UX on any device.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Feincraft/TrulyResponsive" class="md-button md-button--primary" target="_blank" rel="noopener">
