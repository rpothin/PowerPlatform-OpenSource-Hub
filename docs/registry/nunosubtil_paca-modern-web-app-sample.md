...
<section class="mdx-detail-hero">
  <h1>paca-modern-web-app-sample</h1>
  <p class="mdx-detail-hero__description">Modern Web App Sample for Power Apps Code Apps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/nunosubtil/paca-modern-web-app-sample" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2025-09-25</span>
    <span>Updated 2026-03-22</span>
    <span><a href="https://exodia.pt/" target="_blank" rel="noopener">https://exodia.pt/</a></span>
  </div>
</section>
