...
<section class="mdx-detail-hero">
  <h1>dataverse-gen</h1>
  <p class="mdx-detail-hero__description">Early-bound types generator for CDS/Dataverse</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/scottdurow/dataverse-gen" class="md-button md-button--primary" target="_blank" rel="noopener">
