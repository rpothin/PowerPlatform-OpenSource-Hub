...
<section class="mdx-detail-hero">
  <h1>Niam.XRM.Framework</h1>
  <p class="mdx-detail-hero__description">A dynamics CRM 365 plugin framework that easy to use and simplify server side custom development</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/khairuddinniam/Niam.XRM.Framework" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>C#</span>
    <span>None</span>
    <span>Created 2017-10-10</span>
    <span>Updated 2025-03-26</span>
  </div>
</section>
