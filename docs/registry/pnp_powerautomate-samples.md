...
<section class="mdx-detail-hero">
  <h1>powerautomate-samples</h1>
  <p class="mdx-detail-hero__description">Contains curated community samples for Microsoft Power Automate</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/pnp/powerautomate-samples" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 341</div>
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 135</div>
