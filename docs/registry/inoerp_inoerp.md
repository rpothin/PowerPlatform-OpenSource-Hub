...
<section class="mdx-detail-hero">
  <h1>inoERP</h1>
  <p class="mdx-detail-hero__description">inoERP is an OneApp [ Go back-end & Flutter front-end ] based enterprise management system</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/inoerp/inoERP" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2014-01-30</span>
    <span>Updated 2026-03-28</span>
    <span><a href="http://docs.inoerp.com/" target="_blank" rel="noopener">http://docs.inoerp.com/</a></span>
  </div>
</section>

<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 830</div>
    <div class="mdx-detail-stats__label">Stars</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">👁️ 128</div>
    <div class="mdx-detail-stats__label">Watchers</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 684</div>
