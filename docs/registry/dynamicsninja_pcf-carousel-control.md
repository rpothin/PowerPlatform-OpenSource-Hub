...
<section class="mdx-detail-hero">
  <h1>PCF-Carousel-Control</h1>
  <p class="mdx-detail-hero__description">PCF Carousel Control made with Bootstrap 4 that shows images from entity notes/attachments. Control is bound to Single Line of Text field.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/DynamicsNinja/PCF-Carousel-Control" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2019-06-06</span>
    <span>Updated 2025-02-28</span>
  </div>
</section>
