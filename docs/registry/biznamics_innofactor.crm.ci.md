...
<section class="mdx-detail-hero">
  <h1>Innofactor.Crm.CI</h1>
  <p class="mdx-detail-hero__description">DevOps tools for Microsoft Dynamics 365</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Biznamics/Innofactor.Crm.CI" class="md-button md-button--primary" target="_blank" rel="noopener">
