...
<section class="mdx-detail-hero">
  <h1>orchestrator_rpa</h1>
  <p class="mdx-detail-hero__description">Orchestrator RPA is a Django-based platform for managing tasks with automation robots (RPA). Streamline repetitive tasks efficiently.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/daferferso/orchestrator_rpa" class="md-button md-button--primary" target="_blank" rel="noopener">
