...
<section class="mdx-detail-hero">
  <h1>D365FO-oData-T4-MultiFile-Templates</h1>
  <p class="mdx-detail-hero__description">Dynamics 365 Finance and Operations (D365FO) - multi file oData client generation T4 templates</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/batetech/D365FO-oData-T4-MultiFile-Templates" class="md-button md-button--primary" target="_blank" rel="noopener">
