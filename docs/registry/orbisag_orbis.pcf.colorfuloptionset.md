...
<section class="mdx-detail-hero">
  <h1>ORBIS.PCF.ColorfulOptionset</h1>
  <p class="mdx-detail-hero__description">_No description provided._</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ORBISAG/ORBIS.PCF.ColorfulOptionset" class="md-button md-button--primary" target="_blank" rel="noopener">
