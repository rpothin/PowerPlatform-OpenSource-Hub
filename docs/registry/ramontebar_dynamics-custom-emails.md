...
<section class="mdx-detail-hero">
  <h1>dynamics-custom-emails</h1>
  <p class="mdx-detail-hero__description">Dynamics Custom Email is an extension for Microsoft Dynamics 365 (CRM) which gives you the ability to send emails from a process (e.g. workflow, action) based on an Email Template with dynamic fields</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ramontebar/dynamics-custom-emails" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2017-08-24</span>
    <span>Updated 2025-08-27</span>
    <span><a href="https://ramontebar.wordpress.com/2017/08/30/dynamics-custom-emails-migrated-to-github/" target="_blank" rel="noopener">https://ramontebar.wordpress.com/2017/08/30/dynamics-custom-emails-migrated-to-github/</a></span>
  </div>
</section>
