...
<section class="mdx-detail-hero">
  <h1>PCF-CustomControlBuilder</h1>
  <p class="mdx-detail-hero__description">XrmToolBox Plugin for building and deploying custom control using PCF</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Power-Maverick/PCF-CustomControlBuilder" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2019-06-23</span>
    <span>Updated 2025-10-12</span>
  </div>
</section>

<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 44</div>
