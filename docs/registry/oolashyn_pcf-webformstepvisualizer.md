...
<section class="mdx-detail-hero">
  <h1>PCF-WebFormStepVisualizer</h1>
  <p class="mdx-detail-hero__description">Web Form Steps Visualizer Component using Powerapps Component Framework</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OOlashyn/PCF-WebFormStepVisualizer" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-06-27</span>
    <span>Updated 2025-08-04</span>
  </div>
</section>
