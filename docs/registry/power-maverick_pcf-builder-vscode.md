...
<section class="mdx-detail-hero">
  <h1>PCF-Builder-VSCode</h1>
  <p class="mdx-detail-hero__description">Build your Power Apps Component Framework custom controls faster. No need to remember the PCF CLI commands. All commands provided in one selection list for you to execute. https://marketplace.visualstudio.com/items?itemName=danish-naglekar.pcf-builder</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Power-Maverick/PCF-Builder-VSCode" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-05-03</span>
    <span>Updated 2026-01-17</span>
  </div>
</section>
