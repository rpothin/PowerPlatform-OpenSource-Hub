...
<section class="mdx-detail-hero">
  <h1>powerful</h1>
  <p class="mdx-detail-hero__description">A demo showing how to maintain persistency on Power Platform by installing an automation factory that creates, executes and deletes arbitrary commands.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/mbrg/powerful" class="md-button md-button--primary" target="_blank" rel="noopener">
