...
<section class="mdx-detail-hero">
  <h1>BusinessProcessFlowViewer</h1>
  <p class="mdx-detail-hero__description">This component displays BPFs with all process stages categories of entities from a grid/views</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/allandecastro/BusinessProcessFlowViewer" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2019-07-12</span>
    <span>Updated 2026-02-20</span>
  </div>
</section>
