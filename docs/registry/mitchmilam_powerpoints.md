...
<section class="mdx-detail-hero">
  <h1>PowerPoints</h1>
  <p class="mdx-detail-hero__description">Here are all of the PowerPoint presentations that I have ever created and presented.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MitchMilam/PowerPoints" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-12-28</span>
    <span>Updated 2025-04-12</span>
  </div>
</section>
