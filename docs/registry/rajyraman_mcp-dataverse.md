...
<section class="mdx-detail-hero">
  <h1>mcp-dataverse</h1>
  <p class="mdx-detail-hero__description">MCP Server for querying Dataverse using SQL</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rajyraman/mcp-dataverse" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2025-04-03</span>
    <span>Updated 2026-02-04</span>
  </div>
</section>
