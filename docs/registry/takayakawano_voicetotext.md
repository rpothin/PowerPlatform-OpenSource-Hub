...
<section class="mdx-detail-hero">
  <h1>VoiceToText</h1>
  <p class="mdx-detail-hero__description">This solution is the voice to text by using Bing Speech API with Dynamics 365.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/takayakawano/VoiceToText" class="md-button md-button--primary" target="_blank" rel="noopener">
