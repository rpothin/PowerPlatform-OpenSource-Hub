...
<section class="mdx-detail-hero">
  <h1>vsc-xliff-sync</h1>
  <p class="mdx-detail-hero__description">Visual Studio Code extension that allows for automatic merging of (simple) XLIFF translation files.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rvanbekkum/vsc-xliff-sync" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2019-01-30</span>
    <span>Updated 2026-03-19</span>
    <span><a href="https://marketplace.visualstudio.com/items?itemName=rvanbekkum.xliff-sync" target="_blank" rel="noopener">https://marketplace.visualstudio.com/items?itemName=rvanbekkum.xliff-sync</a></span>
  </div>
</section>
