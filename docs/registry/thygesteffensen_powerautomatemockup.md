...
<section class="mdx-detail-hero">
  <h1>PowerAutomateMockUp</h1>
  <p class="mdx-detail-hero__description">Skeleton to run Power Automate Flows from their JSON descriptions.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/thygesteffensen/PowerAutomateMockUp" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-11-24</span>
    <span>Updated 2025-11-12</span>
  </div>
</section>
