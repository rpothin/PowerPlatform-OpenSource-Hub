...
<section class="mdx-detail-hero">
  <h1>WarehouseControlSystem</h1>
  <p class="mdx-detail-hero__description">Warehouse Control System for Microsoft Dynamics NAV</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OlegLobakov/WarehouseControlSystem" class="md-button md-button--primary" target="_blank" rel="noopener">
