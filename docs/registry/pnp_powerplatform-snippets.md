...
<section class="mdx-detail-hero">
  <h1>powerplatform-snippets</h1>
  <p class="mdx-detail-hero__description">Repository with snippets that can easily be used in some of the Power Platform products</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/pnp/powerplatform-snippets" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 210</div>
