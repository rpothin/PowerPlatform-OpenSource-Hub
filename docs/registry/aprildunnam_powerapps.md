...
<section class="mdx-detail-hero">
  <h1>PowerApps</h1>
  <p class="mdx-detail-hero__description">Collection of Power Apps template apps, components and examples</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/aprildunnam/PowerApps" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 541</div>
    <div class="mdx-detail-stats__label">Stars</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">👁️ 54</div>
    <div class="mdx-detail-stats__label">Watchers</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 237</div>
