...
<section class="mdx-detail-hero">
  <h1>PCFGrapesJSEditor</h1>
  <p class="mdx-detail-hero__description">PCF Control for GrapesJS Editor</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/irah2008/PCFGrapesJSEditor" class="md-button md-button--primary" target="_blank" rel="noopener">
