...
<section class="mdx-detail-hero">
  <h1>powerapps-project-template</h1>
  <p class="mdx-detail-hero__description">A Yeoman generator for scaffolding Power Apps projects based on our tooling and best practices.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Capgemini/powerapps-project-template" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 46</div>
