...
<section class="mdx-detail-hero">
  <h1>D365-CE-Pipelines</h1>
  <p class="mdx-detail-hero__description">Collection of YAML files for building Azure DevOps pipelines for Dynamics 365 for Customer Engagement</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft-d365-ce-pfe-devops/D365-CE-Pipelines" class="md-button md-button--primary" target="_blank" rel="noopener">
