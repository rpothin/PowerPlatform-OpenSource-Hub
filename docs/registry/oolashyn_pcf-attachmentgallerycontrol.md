...
<section class="mdx-detail-hero">
  <h1>PCF-AttachmentGalleryControl</h1>
  <p class="mdx-detail-hero__description">Attachment Gallery Control using Powerapps Component Framework</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OOlashyn/PCF-AttachmentGalleryControl" class="md-button md-button--primary" target="_blank" rel="noopener">
