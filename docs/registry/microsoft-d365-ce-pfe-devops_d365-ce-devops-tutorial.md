...
<section class="mdx-detail-hero">
  <h1>D365-CE-DevOps-Tutorial</h1>
  <p class="mdx-detail-hero__description">Dynamics 365 Customer Engagement DevOps tutorial material repository</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft-d365-ce-pfe-devops/D365-CE-DevOps-Tutorial" class="md-button md-button--primary" target="_blank" rel="noopener">
