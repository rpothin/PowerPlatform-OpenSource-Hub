...
<section class="mdx-detail-hero">
  <h1>PowerAppsScripts</h1>
  <p class="mdx-detail-hero__description">PowerShell scripts for PowerApps and Flow automation</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/denise-msft/PowerAppsScripts" class="md-button md-button--primary" target="_blank" rel="noopener">
