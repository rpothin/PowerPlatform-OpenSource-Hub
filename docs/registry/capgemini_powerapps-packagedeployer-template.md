...
<section class="mdx-detail-hero">
  <h1>powerapps-packagedeployer-template</h1>
  <p class="mdx-detail-hero__description">Enhanced deployment capabilities when deploying with the Power Apps Package Deployer.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Capgemini/powerapps-packagedeployer-template" class="md-button md-button--primary" target="_blank" rel="noopener">
