...
<section class="mdx-detail-hero">
  <h1>erpl-web</h1>
  <p class="mdx-detail-hero__description">ERPL is a DuckDB extension to connect to API based ecosystems via standard interfaces like OData, GraphQL and REST. This works e.g. for SAP ERP, SAP Ariba, SAP C4C, Microsoft Dynamics and many more.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/DataZooDE/erpl-web" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span><a href="https://erpl.io" target="_blank" rel="noopener">https://erpl.io</a></span>
  </div>
</section>
