...
<section class="mdx-detail-hero">
  <h1>copilot-sap-sales-order-verification</h1>
  <p class="mdx-detail-hero__description">_No description provided._</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Azure-Samples/copilot-sap-sales-order-verification" class="md-button md-button--primary" target="_blank" rel="noopener">
