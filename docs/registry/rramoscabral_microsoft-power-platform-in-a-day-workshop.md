...
<section class="mdx-detail-hero">
  <h1>Microsoft-Power-Platform-In-a-Day-Workshop</h1>
  <p class="mdx-detail-hero__description">Microsoft Power Platform In a Day Workshop</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rramoscabral/Microsoft-Power-Platform-In-a-Day-Workshop" class="md-button md-button--primary" target="_blank" rel="noopener">
