...
<section class="mdx-detail-hero">
  <h1>nhn-toast-notification-service-custom-connector</h1>
  <p class="mdx-detail-hero__description">This is to provide Microsoft Power Platform with a custom connector for NHN Toast Notification Services including SMS/MMS and KakaoTalk messages</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/devrel-kr/nhn-toast-notification-service-custom-connector" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2022-03-10</span>
    <span>Updated 2025-02-05</span>
  </div>
</section>
