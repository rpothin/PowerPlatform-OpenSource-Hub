...
<section class="mdx-detail-hero">
  <h1>dataverse-powertools</h1>
  <p class="mdx-detail-hero__description">Dataverse Powertools contains tools and templates to help with the development of Dataverse and Dynamics 365 projects.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/pete-mc/dataverse-powertools" class="md-button md-button--primary" target="_blank" rel="noopener">
