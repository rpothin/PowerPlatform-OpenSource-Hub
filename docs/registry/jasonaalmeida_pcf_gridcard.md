...
<section class="mdx-detail-hero">
  <h1>PCF_GridCard</h1>
  <p class="mdx-detail-hero__description">A PCF control to render a grid (built specifically for single record grids) as a traditional list of fields in a section</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/jasonaalmeida/PCF_GridCard" class="md-button md-button--primary" target="_blank" rel="noopener">
