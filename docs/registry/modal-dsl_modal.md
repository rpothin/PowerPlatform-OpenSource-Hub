...
<section class="mdx-detail-hero">
  <h1>modal</h1>
  <p class="mdx-detail-hero__description">A Domain Specific Language for AL Extension Development</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/modal-dsl/modal" class="md-button md-button--primary" target="_blank" rel="noopener">
