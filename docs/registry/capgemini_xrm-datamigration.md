...
<section class="mdx-detail-hero">
  <h1>xrm-datamigration</h1>
  <p class="mdx-detail-hero__description">Export and import data for Microsoft Dataverse. Supports JSON and CSV.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Capgemini/xrm-datamigration" class="md-button md-button--primary" target="_blank" rel="noopener">
