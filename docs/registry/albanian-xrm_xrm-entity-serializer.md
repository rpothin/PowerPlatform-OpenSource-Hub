...
<section class="mdx-detail-hero">
  <h1>Xrm-Entity-Serializer</h1>
  <p class="mdx-detail-hero__description">This library can serialize an Microsoft.Xrm.Sdk.Entity to Json and back using Newtonsoft.Json library.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/albanian-xrm/Xrm-Entity-Serializer" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2018-11-23</span>
    <span>Updated 2025-03-31</span>
  </div>
</section>
