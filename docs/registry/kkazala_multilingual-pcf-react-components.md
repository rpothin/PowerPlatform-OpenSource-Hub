...
<section class="mdx-detail-hero">
  <h1>Multilingual-PCF-React-components</h1>
  <p class="mdx-detail-hero__description">A Set of Multilingual PCF components for model-driven apps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/kkazala/Multilingual-PCF-React-components" class="md-button md-button--primary" target="_blank" rel="noopener">
