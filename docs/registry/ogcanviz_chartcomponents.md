...
<section class="mdx-detail-hero">
  <h1>ChartComponents</h1>
  <p class="mdx-detail-hero__description">SVG chart components for Microsoft Power Apps.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OGcanviz/ChartComponents" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>Unknown</span>
    <span>None</span>
    <span>Created 2019-02-20</span>
    <span>Updated 2025-12-15</span>
    <span><a href="https://www.canviz.com" target="_blank" rel="noopener">https://www.canviz.com</a></span>
  </div>
</section>
