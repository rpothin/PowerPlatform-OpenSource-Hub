...
<section class="mdx-detail-hero">
  <h1>SertanDevAXExamples</h1>
  <p class="mdx-detail-hero__description">Examples and exercises from Sertan's Dev Blog</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/sertanyaman/SertanDevAXExamples" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>Unknown</span>
    <span>None</span>
    <span>Created 2017-01-30</span>
    <span>Updated 2025-07-09</span>
    <span><a href="http://devblog.sertanyaman.com" target="_blank" rel="noopener">http://devblog.sertanyaman.com</a></span>
  </div>
</section>
