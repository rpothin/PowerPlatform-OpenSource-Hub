...
<section class="mdx-detail-hero">
  <h1>XrmToolBox</h1>
  <p class="mdx-detail-hero__description">An application that gather multiple tools to ease the customization and configuration of Microsoft Dynamics CRM/365/Dataverse/PowerApps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MscrmTools/XrmToolBox" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2015-02-05</span>
    <span>Updated 2026-03-30</span>
    <span><a href="https://www.xrmtoolbox.com" target="_blank" rel="noopener">https://www.xrmtoolbox.com</a></span>
  </div>
</section>

<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 629</div>
    <div class="mdx-detail-stats__label">Stars</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">👁️ 77</div>
    <div class="mdx-detail-stats__label">Watchers</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 229</div>
    <div class="mdx-detail-stats__label">Forks</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 114</div>
