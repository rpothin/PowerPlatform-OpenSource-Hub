...
<section class="mdx-detail-hero">
  <h1>MscrmTools.PortalRecordsMover</h1>
  <p class="mdx-detail-hero__description">Export/Import Dynamics 365 portal records</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MscrmTools/MscrmTools.PortalRecordsMover" class="md-button md-button--primary" target="_blank" rel="noopener">
    ...
    <span class="registry-badge">dynamics-365</span> <span class="registry-badge">portal</span> <span class="registry-badge">xrmtoolbox</span>
  </div>
