...
<section class="mdx-detail-hero">
  <h1>Dataverse-Dialog-Builder</h1>
  <p class="mdx-detail-hero__description">A managed solution helps you build Microsoft Dataverse OOB dialogs, such as the Assign dialog, Close Opportunity dialog, ...</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/phuocle/Dataverse-Dialog-Builder" class="md-button md-button--primary" target="_blank" rel="noopener">
