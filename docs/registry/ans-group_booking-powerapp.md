...
<section class="mdx-detail-hero">
  <h1>booking-powerapp</h1>
  <p class="mdx-detail-hero__description">Booking Application built with Microsoft PowerApps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ans-group/booking-powerapp" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>TSQL</span>
    <span>None</span>
    <span>Created 2020-06-24</span>
    <span>Updated 2025-11-05</span>
  </div>
</section>
