...
<section class="mdx-detail-hero">
  <h1>dataverse-mcp</h1>
  <p class="mdx-detail-hero__description">A Model Context Protocol (MCP) server for Microsoft Dataverse that enables schema operations including creating and updating tables, columns, relationships, and option sets using the Dataverse Web API.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/mwhesse/dataverse-mcp" class="md-button md-button--primary" target="_blank" rel="noopener">
