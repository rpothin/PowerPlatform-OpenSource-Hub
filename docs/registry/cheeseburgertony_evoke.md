...
<section class="mdx-detail-hero">
  <h1>evoke</h1>
  <p class="mdx-detail-hero__description">AI-powered web app generator — turn natural language ideas into full code with live preview and code explorer ｜AI 驱动的 Web 应用生成平台，通过自然语言对话生成完整可运行的代码，并提供实时预览与代码浏览</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/cheeseburgertony/evoke" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2025-11-14</span>
    <span>Updated 2026-04-05</span>
    <span><a href="https://evoke-mocha.vercel.app" target="_blank" rel="noopener">https://evoke-mocha.vercel.app</a></span>
  </div>
</section>

<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 131</div>
