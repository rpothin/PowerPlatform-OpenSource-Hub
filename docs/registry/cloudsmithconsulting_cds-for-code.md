...
<section class="mdx-detail-hero">
  <h1>cds-for-code</h1>
  <p class="mdx-detail-hero__description">VSCode extension for working with Microsoft Common Data Service (CDS)</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/cloudsmithconsulting/cds-for-code" class="md-button md-button--primary" target="_blank" rel="noopener">
