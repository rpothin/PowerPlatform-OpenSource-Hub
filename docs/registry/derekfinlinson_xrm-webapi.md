...
<section class="mdx-detail-hero">
  <h1>xrm-webapi</h1>
  <p class="mdx-detail-hero__description">Dynamics 365 Web Api TypeScript module</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/derekfinlinson/xrm-webapi" class="md-button md-button--primary" target="_blank" rel="noopener">
