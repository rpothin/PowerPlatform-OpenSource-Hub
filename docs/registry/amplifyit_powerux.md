...
<section class="mdx-detail-hero">
  <h1>powerux</h1>
  <p class="mdx-detail-hero__description">PowerUX is a no-code UX extender for model-driven apps, designed to empower low-code enthusiasts. Seamlessly customize and enhance the user experience of Dynamics 365 CE and model-driven apps without needing to write a single line of code.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/amplifyit/powerux" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2024-08-24</span>
    <span>Updated 2025-09-22</span>
    <span><a href="https://powerux.app" target="_blank" rel="noopener">https://powerux.app</a></span>
  </div>
</section>
