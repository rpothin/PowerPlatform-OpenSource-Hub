...
<section class="mdx-detail-hero">
  <h1>FetchXmlTester</h1>
  <p class="mdx-detail-hero__description">Test FetchXml Online without providing credentials using WebAPI GET Call</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/AshV/FetchXmlTester" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>None</span>
    <span>Created 2017-12-13</span>
    <span>Updated 2025-12-20</span>
    <span><a href="https://www.ashishvishwakarma.com/FetchXmlTester//" target="_blank" rel="noopener">https://www.ashishvishwakarma.com/FetchXmlTester//</a></span>
  </div>
</section>
