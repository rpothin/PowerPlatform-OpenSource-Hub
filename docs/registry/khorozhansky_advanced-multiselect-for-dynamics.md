...
<section class="mdx-detail-hero">
  <h1>Advanced-MultiSelect-for-Dynamics</h1>
  <p class="mdx-detail-hero__description">Advanced MultiSelect for Dynamics 365 / Dynamics CRM is a multi-select / multi-checkbox control on a form. It represents a set of related data items (based on N:N relations + FetchXml) and gives a user an ability to associate/disassociate records of related entities in a quick and convenient way.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/khorozhansky/Advanced-MultiSelect-for-Dynamics" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2016-12-05</span>
    <span>Updated 2024-11-30</span>
  </div>
</section>
