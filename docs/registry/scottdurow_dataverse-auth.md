...
<section class="mdx-detail-hero">
  <h1>dataverse-auth</h1>
  <p class="mdx-detail-hero__description">Performs on-behalf-of auth against a Microsoft Dataverse environment using pure NodeJS.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/scottdurow/dataverse-auth" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-04-15</span>
    <span>Updated 2025-11-10</span>
  </div>
</section>
