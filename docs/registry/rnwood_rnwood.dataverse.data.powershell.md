...
<section class="mdx-detail-hero">
  <h1>Rnwood.Dataverse.Data.PowerShell</h1>
  <p class="mdx-detail-hero__description">A PowerShell module for interacting with Microsoft Dataverse.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rnwood/Rnwood.Dataverse.Data.PowerShell" class="md-button md-button--primary" target="_blank" rel="noopener">
