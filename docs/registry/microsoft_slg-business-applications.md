...
<section class="mdx-detail-hero">
  <h1>SLG-Business-Applications</h1>
  <p class="mdx-detail-hero__description">A collection of Power Platform and Dynamics 365 resources, open-sourced to the State & Local Government community.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/SLG-Business-Applications" class="md-button md-button--primary" target="_blank" rel="noopener">
