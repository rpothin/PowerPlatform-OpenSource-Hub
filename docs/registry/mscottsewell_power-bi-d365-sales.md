...
<section class="mdx-detail-hero">
  <h1>Power-BI-D365-Sales</h1>
  <p class="mdx-detail-hero__description">Power BI ❤️ Dynamics 365 - Sales Report and ALM Solution Examples for Power BI and Dataverse.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/mscottsewell/Power-BI-D365-Sales" class="md-button md-button--primary" target="_blank" rel="noopener">
