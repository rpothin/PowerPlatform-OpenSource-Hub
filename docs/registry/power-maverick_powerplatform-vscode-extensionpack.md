...
<section class="mdx-detail-hero">
  <h1>PowerPlatform-VSCode-ExtensionPack</h1>
  <p class="mdx-detail-hero__description">The ultimate collection of extensions for Power Platform!</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Power-Maverick/PowerPlatform-VSCode-ExtensionPack" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2021-12-03</span>
    <span>Updated 2025-10-01</span>
    <span><a href="https://marketplace.visualstudio.com/items?itemName=danish-naglekar.power-platform-extension-pack" target="_blank" rel="noopener">https://marketplace.visualstudio.com/items?itemName=danish-naglekar.power-platform-extension-pack</a></span>
  </div>
</section>
