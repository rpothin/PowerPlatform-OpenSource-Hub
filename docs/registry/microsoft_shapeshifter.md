...
<section class="mdx-detail-hero">
  <h1>shapeshifter</h1>
  <p class="mdx-detail-hero__description">A way to dynamically render controls in Power Apps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/shapeshifter" class="md-button md-button--primary" target="_blank" rel="noopener">
