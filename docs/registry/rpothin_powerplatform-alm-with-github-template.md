...
<section class="mdx-detail-hero">
  <h1>PowerPlatform-ALM-With-GitHub-Template</h1>
  <p class="mdx-detail-hero__description">Template repository for the ALM of Power Platform solutions with GitHub</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rpothin/PowerPlatform-ALM-With-GitHub-Template" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-10-30</span>
    <span>Updated 2025-07-23</span>
  </div>
</section>
