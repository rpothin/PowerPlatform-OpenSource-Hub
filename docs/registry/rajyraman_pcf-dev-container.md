...
<section class="mdx-detail-hero">
  <h1>pcf-dev-container</h1>
  <p class="mdx-detail-hero__description">Codespaces Template for Power Apps Component Framework development</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rajyraman/pcf-dev-container" class="md-button md-button--primary" target="_blank" rel="noopener">
