...
<section class="mdx-detail-hero">
  <h1>raaghu-react</h1>
  <p class="mdx-detail-hero__description">Raaghu Design System – React is an open-source design system for modern Web and Power Apps applications. Built for the web and extendable to Microsoft’s Power Apps Component Framework (PCF), it offers reusable components that help teams create responsive, consistent, and engaging experiences.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Wai-Technologies/raaghu-react" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span><a href="https://react.raaghu.ai" target="_blank" rel="noopener">https://react.raaghu.ai</a></span>
  </div>
</section>

<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 187</div>
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 1,015</div>
