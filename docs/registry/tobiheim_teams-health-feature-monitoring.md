...
<section class="mdx-detail-hero">
  <h1>teams-health-feature-monitoring</h1>
  <p class="mdx-detail-hero__description">Microsoft Teams service issues and Message Center notifications as Teams posts and to SharePoint lists.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/tobiheim/teams-health-feature-monitoring" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-11-18</span>
    <span>Updated 2024-12-30</span>
  </div>
</section>
