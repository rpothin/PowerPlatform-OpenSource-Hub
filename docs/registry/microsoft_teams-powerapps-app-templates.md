...
<section class="mdx-detail-hero">
  <h1>teams-powerapps-app-templates</h1>
  <p class="mdx-detail-hero__description">Sample Teams app built by Power Apps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/teams-powerapps-app-templates" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 298</div>
