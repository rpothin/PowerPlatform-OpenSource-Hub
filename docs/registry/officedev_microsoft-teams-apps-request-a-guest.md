...
<section class="mdx-detail-hero">
  <h1>microsoft-teams-apps-request-a-guest</h1>
  <p class="mdx-detail-hero__description">Power Apps solution that automates the guest approval and invite process</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/OfficeDev/microsoft-teams-apps-request-a-guest" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2021-03-18</span>
    <span>Updated 2025-12-22</span>
  </div>
</section>
