...
<section class="mdx-detail-hero">
  <h1>awesome-power-automate-learning-resources</h1>
  <p class="mdx-detail-hero__description">A curated collection of learning resources to help deepen your understanding of the Microsoft Power Automate service. Updated regularly. Contributions encouraged via a pull request (see contributing.md).</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/iamericfletcher/awesome-power-automate-learning-resources" class="md-button md-button--primary" target="_blank" rel="noopener">
