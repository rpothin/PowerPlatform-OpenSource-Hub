...
<section class="mdx-detail-hero">
  <h1>easyDataverse</h1>
  <p class="mdx-detail-hero__description">🪐 - Lightweight Dataverse interface in Python to upload, download and update datasets found in Dataverse installations. </p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/gdcc/easyDataverse" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2022-06-16</span>
    <span>Updated 2025-11-27</span>
  </div>
</section>
