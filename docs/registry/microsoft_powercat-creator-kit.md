...
<section class="mdx-detail-hero">
  <h1>powercat-creator-kit</h1>
  <p class="mdx-detail-hero__description">This toolkit helps create well-designed Power App experiences on the web & mobile. It contains a component library; PCF controls and other utilities that increase developer productivity.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/powercat-creator-kit" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 398</div>
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 69</div>
    <div class="mdx-detail-stats__label">Forks</div>
  </div>
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 125</div>
