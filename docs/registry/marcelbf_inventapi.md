...
<section class="mdx-detail-hero">
  <h1>InventAPI</h1>
  <p class="mdx-detail-hero__description">This is a demo repository to showcase scenarios how Professional Developers (AKA code-first developers) can make use of Power Platform to be more productive and/or innovative.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/marcelbf/InventAPI" class="md-button md-button--primary" target="_blank" rel="noopener">
