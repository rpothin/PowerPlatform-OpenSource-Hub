...
<section class="mdx-detail-hero">
  <h1>Power-CAT-Tools</h1>
  <p class="mdx-detail-hero__description">The Power CAT Tools is your ultimate companion for enhancing the development experience within the Power Platform. This powerful suite of features is designed to streamline your development workflow by automating essential tasks and providing insightful guidance based on real-world best practices.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/Power-CAT-Tools" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span><a href="https://appsource.microsoft.com/en-us/product/dynamics-365/microsoftpowercatarch.powercattools" target="_blank" rel="noopener">https://appsource.microsoft.com/en-us/product/dynamics-365/microsoftpowercatarch.powercattools</a></span>
  </div>
</section>
