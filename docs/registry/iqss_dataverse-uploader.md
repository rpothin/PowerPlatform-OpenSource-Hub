...
<section class="mdx-detail-hero">
  ...
  <p class="mdx-detail-hero__description">GitHub Action to publish repository content on Dataverse</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/IQSS/dataverse-uploader" class="md-button md-button--primary" target="_blank" rel="noopener">
