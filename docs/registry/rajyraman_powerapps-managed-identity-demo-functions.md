...
<section class="mdx-detail-hero">
  <h1>PowerApps-Managed-Identity-Demo-Functions</h1>
  <p class="mdx-detail-hero__description">Demo repository to show how to use Managed Identity on Azure Functions to connect to Power Apps Web API.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rajyraman/PowerApps-Managed-Identity-Demo-Functions" class="md-button md-button--primary" target="_blank" rel="noopener">
