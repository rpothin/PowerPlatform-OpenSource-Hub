...
<section class="mdx-detail-hero">
  <h1>PCF-ScheduleBoardView</h1>
  <p class="mdx-detail-hero__description">This control converts any dataset that has start date and end date in its records into Schedule Board</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/BeverCRM/PCF-ScheduleBoardView" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2022-08-31</span>
    <span>Updated 2025-02-26</span>
