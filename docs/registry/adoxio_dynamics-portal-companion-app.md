...
<section class="mdx-detail-hero">
  <h1>dynamics-portal-companion-app</h1>
  <p class="mdx-detail-hero__description">A starter template for a Dynamics 365 portal companion web application with Azure AD B2C authentication</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Adoxio/dynamics-portal-companion-app" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2017-09-08</span>
    <span>Updated 2023-01-30</span>
  </div>
</section>
