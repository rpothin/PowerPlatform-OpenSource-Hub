...
<section class="mdx-detail-hero">
  <h1>bcsamples-takeorder</h1>
  <p class="mdx-detail-hero__description">The Take Order sample demonstrates how you can build a customized user experience for servers at restaurants, using Power Apps powered by Business Central.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/bcsamples-takeorder" class="md-button md-button--primary" target="_blank" rel="noopener">
