...
<section class="mdx-detail-hero">
  <h1>PowerPlatformCICD</h1>
  <p class="mdx-detail-hero__description">A Template and Provisioning process to create a fully automated Build and Deploy Project for the Microsoft Power Platform</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/dylanhaskins/PowerPlatformCICD" class="md-button md-button--primary" target="_blank" rel="noopener">
