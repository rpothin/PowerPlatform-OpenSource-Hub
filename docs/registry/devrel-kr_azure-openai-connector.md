...
<section class="mdx-detail-hero">
  <h1>azure-openai-connector</h1>
  <p class="mdx-detail-hero__description">This is a Power Platform custom connector project for OpenAI API and Azure OpenAI Service API.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/devrel-kr/azure-openai-connector" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2023-03-02</span>
    <span>Updated 2023-10-22</span>
  </div>
</section>
