...
<section class="mdx-detail-hero">
  <h1>Power-Fx-.NET-Interactive</h1>
  <p class="mdx-detail-hero__description">Power Fx kernel for .NET Interactive</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/rajyraman/Power-Fx-.NET-Interactive" class="md-button md-button--primary" target="_blank" rel="noopener">
