...
<section class="mdx-detail-hero">
  <h1>Daxif</h1>
  <p class="mdx-detail-hero__description">A framework for automating a lot of xRM development processses. By using simple F# script commands/files one can save a lot of time and effort during this process by using Delegates DAXIF# library.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/delegateas/Daxif" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>F#</span>
    <span>Other</span>
    <span>Created 2016-02-07</span>
    <span>Updated 2025-03-19</span>
  </div>
</section>
