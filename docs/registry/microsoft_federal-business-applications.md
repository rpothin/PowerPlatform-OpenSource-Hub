...
<section class="mdx-detail-hero">
  <h1>Federal-Business-Applications</h1>
  <p class="mdx-detail-hero__description">US Government Business Applications Demo Repository</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/Federal-Business-Applications" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 215</div>
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">🔱 78</div>
