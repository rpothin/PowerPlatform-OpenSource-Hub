...
<section class="mdx-detail-hero">
  <h1>XrmMockup</h1>
  <p class="mdx-detail-hero__description">Engine which simulates your exact Dynamics 365/CRM instance locally including all of it's logic!</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/delegateas/XrmMockup" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 82</div>
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 62</div>
