...
<section class="mdx-detail-hero">
  <h1>AttachmentUploader</h1>
  <p class="mdx-detail-hero__description">A Power App code component to easily upload one or more attachments on Dynamics365 records.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ramarao9/AttachmentUploader" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-01-09</span>
    <span>Updated 2025-08-05</span>
  </div>
</section>
