...
<section class="mdx-detail-hero">
  <h1>Dynamics-Crm-DevKit</h1>
  <p class="mdx-detail-hero__description">A collection of projects/items template for develop Dynamics 365 CRM/CDS/Dataverse</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/phuocle/Dynamics-Crm-DevKit" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2018-03-02</span>
    <span>Updated 2026-02-12</span>
  </div>
</section>

<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 75</div>
