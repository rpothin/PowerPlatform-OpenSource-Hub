...
<section class="mdx-detail-hero">
  <h1>PortalRecordsMoverConsole</h1>
  <p class="mdx-detail-hero__description">Port of the Portal Records Mover XrmToolbox plugin by Tanguy Touzard</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/jamesnovak/PortalRecordsMoverConsole" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2018-07-01</span>
    <span>Updated 2023-04-02</span>
  </div>
</section>
