...
<section class="mdx-detail-hero">
  <h1>sp-document-explorer</h1>
  <p class="mdx-detail-hero__description">Handling SharePoint Documents in Business Central</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/msnraju/sp-document-explorer" class="md-button md-button--primary" target="_blank" rel="noopener">
