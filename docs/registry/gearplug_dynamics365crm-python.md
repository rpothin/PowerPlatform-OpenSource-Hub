...
<section class="mdx-detail-hero">
  <h1>dynamics365crm-python</h1>
  <p class="mdx-detail-hero__description">Dynamics365CRM API wrapper written in Python.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/GearPlug/dynamics365crm-python" class="md-button md-button--primary" target="_blank" rel="noopener">
