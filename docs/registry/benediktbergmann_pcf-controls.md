...
<section class="mdx-detail-hero">
  <h1>PCF-Controls</h1>
  <p class="mdx-detail-hero__description">Controls using the PowerApps Component Framework</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/BenediktBergmann/PCF-Controls" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  ...
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⚠️ 47</div>
