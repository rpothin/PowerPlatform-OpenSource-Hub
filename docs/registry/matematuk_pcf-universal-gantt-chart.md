...
<section class="mdx-detail-hero">
  <h1>pcf-universal-gantt-chart</h1>
  <p class="mdx-detail-hero__description">Interactive PCF Gantt Chart Control for Dynamics Grid</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/MaTeMaTuK/pcf-universal-gantt-chart" class="md-button md-button--primary" target="_blank" rel="noopener">
