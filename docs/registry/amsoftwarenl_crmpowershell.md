...
<section class="mdx-detail-hero">
  <h1>crmpowershell</h1>
  <p class="mdx-detail-hero__description">Manage Power Platform Dataverse metadata and content, and administer the environment. Use on-premises and online.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/AMSoftwareNL/crmpowershell" class="md-button md-button--primary" target="_blank" rel="noopener">
