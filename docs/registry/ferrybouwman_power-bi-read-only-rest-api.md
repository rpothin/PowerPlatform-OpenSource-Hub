...
<section class="mdx-detail-hero">
  <h1>Power-BI-Read-Only-REST-API</h1>
  <p class="mdx-detail-hero__description">Solution based on either Powershell or Power Automate (Flow) to consume the recently released Power BI Asynchronous Unified Scanning API</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ferrybouwman/Power-BI-Read-Only-REST-API" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>None</span>
    <span>Created 2020-12-29</span>
    <span>Updated 2026-01-21</span>
  </div>
</section>
