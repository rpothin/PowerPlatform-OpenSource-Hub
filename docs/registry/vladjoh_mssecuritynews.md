...
<section class="mdx-detail-hero">
  <h1>mssecuritynews</h1>
  <p class="mdx-detail-hero__description">A set of Power Automate flows that fetch the latest Microsoft Security News from various sources directly into your Teams chat or channels.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/vladjoh/mssecuritynews" class="md-button md-button--primary" target="_blank" rel="noopener">
