...
<section class="mdx-detail-hero">
  <h1>Power-Platform-ALM-Starter-Kit</h1>
  <p class="mdx-detail-hero__description">Kit to help you start your DevOps journey with the Power Platform</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Power-Platform-DevOps/Power-Platform-ALM-Starter-Kit" class="md-button md-button--primary" target="_blank" rel="noopener">
