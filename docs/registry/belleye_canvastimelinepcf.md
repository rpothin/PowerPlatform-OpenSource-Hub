...
<section class="mdx-detail-hero">
  <h1>CanvasTimelinePCF</h1>
  <p class="mdx-detail-hero__description">Power Apps Canvas PCF based on vis-timeline</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Belleye/CanvasTimelinePCF" class="md-button md-button--primary" target="_blank" rel="noopener">
