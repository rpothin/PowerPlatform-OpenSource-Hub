...
<section class="mdx-detail-hero">
  <h1>Power-Apps-Toast-Notification-Component</h1>
  <p class="mdx-detail-hero__description">Component created for toast style notifications to be used in Power Apps Canvas Apps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/erfernandes/Power-Apps-Toast-Notification-Component" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>Unknown</span>
    <span>None</span>
    <span>Created 2022-08-04</span>
    <span>Updated 2025-11-03</span>
  </div>
</section>
