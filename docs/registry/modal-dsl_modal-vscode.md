...
<section class="mdx-detail-hero">
  <h1>modal-vscode</h1>
  <p class="mdx-detail-hero__description">VS Code Language Extension adding support for modAL</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/modal-dsl/modal-vscode" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2020-05-11</span>
    <span>Updated 2024-09-03</span>
    <span><a href="https://marketplace.visualstudio.com/items?itemName=joneug.mdal" target="_blank" rel="noopener">https://marketplace.visualstudio.com/items?itemName=joneug.mdal</a></span>
  </div>
</section>
