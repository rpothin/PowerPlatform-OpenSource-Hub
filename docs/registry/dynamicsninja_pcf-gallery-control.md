...
<section class="mdx-detail-hero">
  <h1>PCF-Gallery-Control</h1>
  <p class="mdx-detail-hero__description">PCF control that shows thumbnails of images from entity notes. Control is bound to Single Line of Text field.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/DynamicsNinja/PCF-Gallery-Control" class="md-button md-button--primary" target="_blank" rel="noopener">
