...
<section class="mdx-detail-hero">
  <h1>D365FFO-PowerShell-scripts</h1>
  <p class="mdx-detail-hero__description">Set of PowerShell scripts to maintain D365FFO (Dynamics 365 for Finance and Operations)</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/valerymoskalenko/D365FFO-PowerShell-scripts" class="md-button md-button--primary" target="_blank" rel="noopener">
