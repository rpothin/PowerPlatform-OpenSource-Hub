...
<section class="mdx-detail-hero">
  <h1>PowerProgressive</h1>
  <p class="mdx-detail-hero__description">Run #PowerApps as native desktop apps with this PWA conversion kit</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Feincraft/PowerProgressive" class="md-button md-button--primary" target="_blank" rel="noopener">
