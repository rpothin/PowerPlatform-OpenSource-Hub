...
<section class="mdx-detail-hero">
  <h1>ALWebServiceExamples</h1>
  <p class="mdx-detail-hero__description">AL code examples to call web services with Dynamics 365 for Financials and Operations, Business Edition.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ajkauffmann/ALWebServiceExamples" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2017-07-17</span>
    <span>Updated 2025-08-25</span>
    <span><a href="http://kauffmann.nl" target="_blank" rel="noopener">http://kauffmann.nl</a></span>
  </div>
</section>
