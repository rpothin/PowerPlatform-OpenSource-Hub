...
<section class="mdx-detail-hero">
  <h1>canvas-apps-tools</h1>
  <p class="mdx-detail-hero__description">AI skills for Power Apps Canvas Apps - Generate paste-ready Power Apps Canvas App YAML from screenshots, mockups, or text descriptions</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/ToluVictor/canvas-apps-tools" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 80</div>
