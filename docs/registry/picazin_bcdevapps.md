...
<section class="mdx-detail-hero">
  <h1>BCDevApps</h1>
  <p class="mdx-detail-hero__description">Tools to improve and make BC developers easy</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/picazin/BCDevApps" class="md-button md-button--primary" target="_blank" rel="noopener">
