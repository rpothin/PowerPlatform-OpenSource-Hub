...
<section class="mdx-detail-hero">
  ...
  <p class="mdx-detail-hero__description">The Visitor Management is a collection of four Power Apps to manage smart factory visitors.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/teamruegg/VisitorManagement" class="md-button md-button--primary" target="_blank" rel="noopener">
