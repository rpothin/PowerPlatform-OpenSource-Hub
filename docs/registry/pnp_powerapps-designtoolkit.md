...
<section class="mdx-detail-hero">
  <h1>powerapps-designtoolkit</h1>
  <p class="mdx-detail-hero__description">This toolkit is a curated repo of Power Apps UI Guidance and Components that you can plug and play into your apps to transform your design.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/pnp/powerapps-designtoolkit" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 220</div>
