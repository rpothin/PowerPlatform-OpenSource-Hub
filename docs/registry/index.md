...
-   :star: **portaljs** · 2,271 stars · `TypeScript`
    ...
    🌀 Rapidly build feature-rich data portals using a modern frontend framework. Native CKAN support. Op…
...
-   :star: **XrmToolBox** · 629 stars · `C#`
    ...
    An application that gather multiple tools to ease the customization and configuration of Microsoft D…

    [:octicons-arrow-right-24: View details](mscrmtools_xrmtoolbox.md)

-   :star: **viber3d** · 612 stars · `TypeScript`
...
-   :star: **powerplatform-actions** · 281 stars · `TypeScript`
...
-   :star: **powerplatform-actions-lab** · 174 stars · `Unknown`
...
??? note "View all remaining repositories"
    ...
    | [developerkorea](microsoft_developerkorea.md) | C# | :star: 68 | 마이크로소프트 기술 블로그 한국어판 | Microsoft tech blogs in Korean |
    | [PCF-Controls](power-maverick_pcf-controls.md) | TypeScript | :star: 67 | Repos of Powerapps Component Framework (PCF) Controls |
    | [WarehouseControlSystem](oleglobakov_warehousecontrolsystem.md) | C# | :star: 66 | Warehouse Control System for Microsoft Dynamics NAV |
    ...
    | [odata2poco](moh-hassan_odata2poco.md) | C# | :star: 65 | generate POCO classes from OData service |
    ...
    | [pcf-universal-gantt-chart](matematuk_pcf-universal-gantt-chart.md) | TypeScript | :star: 62 | Interactive PCF Gantt Chart Control for Dynamics Grid |
    ...
    | [SSD365VSAddIn](shashisadasivan_ssd365vsaddin.md) | C# | :star: 48 | Visual studio addin for D365 Finance and operations |
    ...
    | [dynamics365crm-python](gearplug_dynamics365crm-python.md) | Python | :star: 45 | Dynamics365CRM API wrapper written in Python. |
    ...
    | [Daxif](delegateas_daxif.md) | F# | :star: 43 | A framework for automating a lot of xRM development processses. By using simple … |
    | [D365FFO-PowerShell-scripts](valerymoskalenko_d365ffo-powershell-scripts.md) | PowerShell | :star: 42 | Set of PowerShell scripts to maintain D365FFO (Dynamics 365 for Finance and Oper… |
    | [teta](ondateta_teta.md) | Dart | :star: 42 | The open source, AI-powered app builder |
    | [FetchXmlFormatter](ashv_fetchxmlformatter.md) | HTML | :star: 41 | Online tool for quick formatting of fetchXML in Dynamics CRM before using into C… |
    ...
    | [PowerProgressive](feincraft_powerprogressive.md) | Unknown | :star: 34 | Run #PowerApps as native desktop apps with this PWA conversion kit |
    | [XrmToolBoxPlugins](deepakkumar1984_xrmtoolboxplugins.md) | C# | :star: 34 | Tools for Dynamics CRM |
    | [vsc-xliff-sync](rvanbekkum_vsc-xliff-sync.md) | TypeScript | :star: 34 | Visual Studio Code extension that allows for automatic merging of (simple) XLIFF… |
    | [BC-OAuth-2.0-Authorization](msnraju_bc-oauth-2.0-authorization.md) | Perl | :star: 34 | Generic OAuth2 Library for Business Central |
    | [AssignPluginDynamics365](ashv_assignplugindynamics365.md) | C# | :star: 33 | Assigning Case to Appropriate Team User Using Plugin in Dynamics CRM / 365 |
    | [JonasPluginBase](rappen_jonaspluginbase.md) | C# | :star: 33 | Microsoft Dynamics CRM / 365 plugin base class |
    | [ChartComponents](ogcanviz_chartcomponents.md) | Unknown | :star: 32 | SVG chart components for Microsoft Power Apps. |
    | [powerapps-project-template](capgemini_powerapps-project-template.md) | C# | :star: 32 | A Yeoman generator for scaffolding Power Apps projects based on our tooling and … |
    | [Power-Platform-ALM-Starter-Kit](power-platform-devops_power-platform-alm-starter-kit.md) | PowerShell | :star: 32 | Kit to help you start your DevOps journey with the Power Platform |
    ...
    | [shapeshifter](microsoft_shapeshifter.md) | TypeScript | :star: 32 | A way to dynamically render controls in Power Apps |
    ...
    | [bcsamples-warehousehelper](microsoft_bcsamples-warehousehelper.md) | AL | :star: 31 | The Warehouse Helper sample consists of an AL extension, a Power App, and a Powe… |
    | [Dynamics365BulkSolutionExporter](ashv_dynamics365bulksolutionexporter.md) | C# | :star: 31 | [Work In Progress] Take backup of whole D365 organization or export multiple sol… |
    | [PCF-AttachmentGalleryControl](oolashyn_pcf-attachmentgallerycontrol.md) | TypeScript | :star: 30 | Attachment Gallery Control using Powerapps Component Framework |
    | [PowerAppsScripts](denise-msft_powerappsscripts.md) | PowerShell | :star: 30 | PowerShell scripts for PowerApps and Flow automation |
    ...
    | [notifyjs](paulnieuwelaar_notifyjs.md) | JavaScript | :star: 30 |  |
    | [PowerPlatform-OpenSource-Hub](rpothin_powerplatform-opensource-hub.md) | TypeScript | :star: 29 | Your amazing journey in Power Platform open-source ecosystem could start here 🧳 |
    | [Power-Platform-Samples](valentinmaz_power-platform-samples.md) | Unknown | :star: 29 | This repository contains Power Platform samples and templates that I share with … |
    | [Crm.Specflow](mvermaat_crm.specflow.md) | C# | :star: 29 | D365 Extension for SpecFlow allows you to automatically test your Dynamics 365 C… |
    ...
    | [DynamicsNode](crisfervil_dynamicsnode.md) | TypeScript | :star: 29 | Create simple scripts to interact with Dynamics CRM using Node.js |
    | [Microsoft.Xrm.DevOps.Data](abvogel_microsoft.xrm.devops.data.md) | C# | :star: 29 | This library provides an easy way to generate filtered data compatible with the … |
    ...
    | [PowerApps-Managed-Identity-Demo-Functions](rajyraman_powerapps-managed-identity-demo-functions.md) | Bicep | :star: 20 | Demo repository to show how to use Managed Identity on Azure Functions to connec… |
    ...
    | [Rnwood.Dataverse.Data.PowerShell](rnwood_rnwood.dataverse.data.powershell.md) | C# | :star: 20 | A PowerShell module for interacting with Microsoft Dataverse. |
    | [harvesterjs](datopian_harvesterjs.md) | TypeScript | :star: 20 | Framework and scripts for harvesting datasets into PortalJS . Provides reusable … |
    | [Dataverse-Dialog-Builder](phuocle_dataverse-dialog-builder.md) | JavaScript | :star: 20 | A managed solution helps you build Microsoft Dataverse OOB dialogs, such as the … |
    | [Adoxio.Dynamics.Connect](adoxio_adoxio.dynamics.connect.md) | C# | :star: 20 | Implements OrganizationWebProxyClient with Dynamics 365 Server-to-Server authent… |
    | [control-add-in-samples](msnraju_control-add-in-samples.md) | Perl | :star: 20 | Microsoft Dynamics 365 Business Central - Control Add-in Samples |
    | [PCF-Gallery-Control](dynamicsninja_pcf-gallery-control.md) | TypeScript | :star: 19 | PCF control that shows thumbnails of images from entity notes. Control is bound … |
    | [release-plans](jukkan_release-plans.md) | HTML | :star: 19 | Release Plans Visualized - Power BI report and website for browsing release item… |
    | [PowerPlatform-VSCode-ExtensionPack](power-maverick_powerplatform-vscode-extensionpack.md) | Unknown | :star: 19 | The ultimate collection of extensions for Power Platform! |
    | [eBusinessCard](experience-digital-ms_ebusinesscard.md) | Unknown | :star: 19 | Contactless Business Card: This component adds a user profile page in your app. … |
    ...
    | [dataverse-uploader](iqss_dataverse-uploader.md) | Python | :star: 19 | GitHub Action to publish repository content on Dataverse |
    | [ORBIS.PCF.ColorfulOptionset](orbisag_orbis.pcf.colorfuloptionset.md) | TypeScript | :star: 18 |  |
    | [paca-modern-web-app-sample](nunosubtil_paca-modern-web-app-sample.md) | TypeScript | :star: 18 | Modern Web App Sample for Power Apps Code Apps |
    ...
    | [microsoft-teams-apps-call-queue-scheduler](officedev_microsoft-teams-apps-call-queue-scheduler.md) | PowerShell | :star: 18 | Microsoft Teams Call Queue Manager app template |
    ...
    | [cces_cumulative](kuriwaki_cces_cumulative.md) | TeX | :star: 18 | Building a cumulative file (2006 - 2024) for the Cooperative Congressional Elect… |
    | [SertanDevAXExamples](sertanyaman_sertandevaxexamples.md) | Unknown | :star: 18 | Examples and exercises from Sertan's Dev Blog |
    | [group-approval-viewer-D365-pcf](tcorcor1_group-approval-viewer-d365-pcf.md) | TypeScript | :star: 18 | Dynamics 365 PCF control for displaying the status of Power Automate group appro… |
    | [Advanced-MultiSelect-for-Dynamics](khorozhansky_advanced-multiselect-for-dynamics.md) | C# | :star: 18 | Advanced MultiSelect for Dynamics 365 / Dynamics CRM is a multi-select / multi-c… |
    ...
    | [gh-codespaces-copilot-in-a-day-ko](azure-samples_gh-codespaces-copilot-in-a-day-ko.md) | Bicep | :star: 17 | GitHub Codespaces & Copilot 핸즈온 워크샵 리포지토리입니다 |
    | [Intelligent-Supply-Chain-Management](msusazureaccelerators_intelligent-supply-chain-management.md) | Jupyter Notebook | :star: 17 | The Supply Chain Management Accelerator leverages deep learning forecasts, Azure… |
    ...
    | [MscrmTools.PortalRecordsMover](mscrmtools_mscrmtools.portalrecordsmover.md) | C# | :star: 17 | Export/Import Dynamics 365 portal records |
    | [Xrm-Quick-Edit](xrm-oss_xrm-quick-edit.md) | JavaScript | :star: 17 | A Dynamics CRM Add-In for speeding up tasks such as translating or toggling fiel… |
    | [dataverse-mcp](mwhesse_dataverse-mcp.md) | TypeScript | :star: 16 | A Model Context Protocol (MCP) server for Microsoft Dataverse that enables schem… |
    | [powerva-samples](pnp_powerva-samples.md) | Unknown | :star: 16 | Contains curated community samples for Microsoft Power Virtual Agents |
    | [nhn-toast-notification-service-custom-connector](devrel-kr_nhn-toast-notification-service-custom-connector.md) | C# | :star: 16 | This is to provide Microsoft Power Platform with a custom connector for NHN Toas… |
    | [Power-Platform-App-Dev-in-a-Day-KR](microsoft_power-platform-app-dev-in-a-day-kr.md) | Bicep | :star: 16 | Power Platform Hands-on-Lab sessions repository in Korean |
    ...
    | [XrmTypesGen](oliverflint_xrmtypesgen.md) | TypeScript | :star: 16 | A Typescript Type Declaration Generator for Dynamics 365 |
    | [SharePointWorkflowConverter](dev-mom_sharepointworkflowconverter.md) | C# | :star: 16 | A proof-of-concept C# console application for retrieving legacy 2010 & 2013 cust… |
    | [orchestrator_rpa](daferferso_orchestrator_rpa.md) | CSS | :star: 16 | Orchestrator RPA is a Django-based platform for managing tasks with automation r… |
    ...
    | [primno](primno_primno.md) | TypeScript | :star: 15 | Front-end framework for Model-Driven Apps of Power Apps and Dynamics 365 |
    | [global-copilot-summit](microsoft_global-copilot-summit.md) | Unknown | :star: 15 | The theme of the summit is Adopt, Extend, and Build Copilot, and is attended by … |
    | [dataverse-auth](scottdurow_dataverse-auth.md) | TypeScript | :star: 15 | Performs on-behalf-of auth against a Microsoft Dataverse environment using pure … |
    ...
    | [ISVLicenseGenerator](aariste_isvlicensegenerator.md) | C# | :star: 15 | MSDyn365FO ISV license generator from USB eToken or Azure Key Vault HSM |
    ...
    | [azure-openai-connector](devrel-kr_azure-openai-connector.md) | Bicep | :star: 13 | This is a Power Platform custom connector project for OpenAI API and Azure OpenA… |
    ...
    | [teams-health-feature-monitoring](tobiheim_teams-health-feature-monitoring.md) | Unknown | :star: 13 | Microsoft Teams service issues and Message Center notifications as Teams posts a… |
    ...
    | [PowerGrid](topness-msft_powergrid.md) | Unknown | :star: 12 |  |
    ...
    | [mssecuritynews](vladjoh_mssecuritynews.md) | Unknown | :star: 12 | A set of Power Automate flows that fetch the latest Microsoft Security News from… |
    ...
    | [Power-Automate-Desktop](jfevia_power-automate-desktop.md) | Unknown | :star: 11 | Publicly released versions of Power Automate for desktop |
    ...
    | [power-automate-bim360-projects-to-onedrive](nseirs_power-automate-bim360-projects-to-onedrive.md) | Unknown | :star: 11 | A Power Automate Flow to export BIM 360 Project data from a selected BIM 360 Acc… |
    ...
    | [vivalearningsharepointstarterkit](microsoft_vivalearningsharepointstarterkit.md) | Unknown | :star: 10 | O Viva Learning SharePoint Starter Kit é um conjunto de ativos que fazem parte d… |
    ...
    | [Power-Platform-Notebooks](rpothin_power-platform-notebooks.md) | Shell | :star: 10 | Notebook templates for support, administration, learning, training... related to… |
    ...
    | [VisitorManagement](teamruegg_visitormanagement.md) | Unknown | :star: 10 | The Visitor Management is a collection of four Power Apps to manage smart factor… |
    | [PCF-DragAndDropGrid](bevercrm_pcf-draganddropgrid.md) | TypeScript | :star: 10 | This control allows to quickly upload Dynamics 365 note attachments by drag and … |
    | [Automate-Testing-for-Power-Apps](packtpublishing_automate-testing-for-power-apps.md) | HLSL | :star: 10 | Material and code related to the book Automate Testing for Power Apps |
    | [D365RichTextEditor](chrismayor_d365richtexteditor.md) | TypeScript | :star: 10 | Dynamics 365 Rich text editor for Unified Interface / Based on PowerApps compone… |
    | [mcp-dataverse](rajyraman_mcp-dataverse.md) | C# | :star: 10 | MCP Server for querying Dataverse using SQL |
    | [cdh-lava-react](cdcgov_cdh-lava-react.md) | CSS | :star: 10 | CDC Data Hub Lifecycle, Analysis & Visualization Accelerator (LAVA) REACT Compon… |
    | [PowerAutomateMockUp](thygesteffensen_powerautomatemockup.md) | C# | :star: 10 | Skeleton to run Power Automate Flows from their JSON descriptions. |
    | [MsCrmTools.MetadataDocumentGenerator](mscrmtools_mscrmtools.metadatadocumentgenerator.md) | C# | :star: 10 | An XrmToolBox plugin to generate Excel documentation with CRM metadata |
    | [D365FOMiddleware](ccampora_d365fomiddleware.md) | Python | :star: 10 | D365 for Finance and Operations Integration Middleware |
    | [xrm-datamigration-xrmtoolbox](capgemini_xrm-datamigration-xrmtoolbox.md) | C# | :star: 9 | Export and import data for Microsoft Dataverse as an XrmToolBox plugin. Supports… |
    | [fake-xrm-easy-samples](dynamicsvalue_fake-xrm-easy-samples.md) | C# | :star: 9 | Sample code for FakeXrmEasy v2 or later |
    | [d365-finance-ops-deprecation-tracker](tcorcor1_d365-finance-ops-deprecation-tracker.md) | Unknown | :star: 9 | Repo used for tracking changes on various D365 F&O deprecation pages |
    | [servicebus-csharp-function-dataverse](rpothin_servicebus-csharp-function-dataverse.md) | PowerShell | :star: 9 | A complete solution that includes everything you need to build, deploy, and moni… |
    | [SafeWorkplace-ContactTracing](aka-enterprise-solutions_safeworkplace-contacttracing.md) | Unknown | :star: 9 | Contact Tracing App to help business maintain a safe office workplace by tracing… |
    | [NativeDialogControl](powerthomas_nativedialogcontrol.md) | TypeScript | :star: 9 | Native Dialog Control is a Power Apps PCF control designed specifically for Cust… |
    ...
    | [d365-cli](hso-nn_d365-cli.md) | TypeScript | :star: 9 | Dynamics 365 Command Line Interface for TypeScript projects for Dataverse |
    | [microsoft-teams-apps-speaker-queue](officedev_microsoft-teams-apps-speaker-queue.md) | Unknown | :star: 9 | Speaker Queue is a Teams meetings extensibility application created to improve y… |
    | [LAMoveCRMAttachmentsToBlob](anilvem1_lamovecrmattachmentstoblob.md) | Unknown | :star: 9 | Move Dynamics 365 CRM attachments (Notes / Email Activity Mime) to Azure Blob st… |
    | [dynamics365](mage2pro_dynamics365.md) | PHP | :star: 9 | Microsoft Dynamics 365 integration with Magento 2 |
    | [DynamicsCrm-NotificationCentre](yagasoft_dynamicscrm-notificationcentre.md) | C# | :star: 9 | A CRM solution that injects a button into CRM's navigation bar, which shows noti… |
    | [DynamicsCrm-Libraries](yagasoft_dynamicscrm-libraries.md) | C# | :star: 9 | A collection of libraries for common and extended operations in Dynamics CRM dev… |
    | [talk-assets](jjgriffin_talk-assets.md) | C# | :star: 9 | Repository storing assets, code examples and other bits relating to talks I have… |
    | [BCWhatsApp](picazin_bcwhatsapp.md) | AL | :star: 9 | Send messages using public WhatsApp API |
    | [XrmUtils-PluginExtensions](emerbrito_xrmutils-pluginextensions.md) | C# | :star: 9 | Extended base class classes for Dynamics 365 plugins and workflows. Wraps the bo… |
    ...
    | [ms-build-learn-notes](kimtth_ms-build-learn-notes.md) | Unknown | :star: 8 | 🪟🍭🖥️ A concise summary of Microsoft's products includes Azure, .NET, M365, Power… |
    | [power-version](ewingjm_power-version.md) | C# | :star: 8 | A NuGet package to version Power Apps solutions at build-time using Git. |
    | [PL-900-Study-Guide](azurementor_pl-900-study-guide.md) | Unknown | :star: 8 | Study Guide for the Microsoft Power Platform Fundamentals Exam |
    ...
    | [power-automate-bim360-issues-to-sql](nseirs_power-automate-bim360-issues-to-sql.md) | Unknown | :star: 8 | A Power Automate Flow and Custom Connector to push BIM 360 issues from a selecte… |
    | [Xrm.DataManager.Framework](aymericm78_xrm.datamanager.framework.md) | C# | :star: 8 | Nuget framework for massive Microsoft Dataverse data operations. |
    | [last-login-mod-D365-vue](tcorcor1_last-login-mod-d365-vue.md) | Vue | :star: 8 | Vue.js web resource used to review Dynamics 365 audit table focusing on user log… |
    | [Solution-Installer-for-XrmToolBox](rajyraman_solution-installer-for-xrmtoolbox.md) | C# | :star: 8 | XrmToolBox tool to download and install solutions from GitHub |
    | [xrmlibrary.2016](emregulcan_xrmlibrary.2016.md) | C# | :star: 8 | Microsoft Dynamics CRM 2016 helper library |
    | [microsoft-graph-api-presence-pcf](taerimhan_microsoft-graph-api-presence-pcf.md) | TypeScript | :star: 8 | Demonstrating consuming Microsoft Graph API from PCF control |
    | [SAP_Product_Copilot](mimergel_sap_product_copilot.md) | Unknown | :star: 7 | An OpenAI-powered Copilot for SAP users, enabling them to view, change, and sele… |
    ...
    | [30-July-2024-DevOps__Boosting-Devops-Productivity-with-Forms-and-Power-Automate](arindam0310018_30-july-2024-devops__boosting-devops-productivity-with-forms-and-power-automate.md) | Unknown | :star: 7 | Boosting Devops Productivity with Forms and Power Automate |
    ...
    | [fo-semantic-mcp](xplusplusai_fo-semantic-mcp.md) | Unknown | :star: 7 | AI-powered semantic search for Microsoft Dynamics 365 F&O development. Find and … |
    | [DynamicsCrm-xrm-mock-Generator](yagasoft_dynamicscrm-xrm-mock-generator.md) | C# | :star: 7 | Generate XRM form models for xrm-mock test framework. |
    | [anikolab.FlowUI](angelonic95_anikolab.flowui.md) | C# | :star: 7 | A C# + JavaScript library to optimize button visibility and loading in the Dynam… |
    | [aibuilder-labs](microsoft_aibuilder-labs.md) | Unknown | :star: 7 | Step-by-step labs for AI Builder & AI prompt use cases |
    | [power-pipelines](ewingjm_power-pipelines.md) | Unknown | :star: 6 | Azure Pipelines templates that provide an end-to-end DevOps framework for Power … |
    | [PowerPlatformLicencing](aarohbits_powerplatformlicencing.md) | Unknown | :star: 6 | All Power Platform licencing Info |
    | [PowerPlatform-CostEstimates](kkazala_powerplatform-costestimates.md) | Unknown | :star: 6 |  |
    | [ms_power_platform_extensions](duncancalvert_ms_power_platform_extensions.md) | HTML | :star: 6 | A repository of reusable code extensions for Microsoft Power Platform (including… |
    ...
    | [PowerPlatform-ALM-Learning-Resources](rpothin_powerplatform-alm-learning-resources.md) | Unknown | :star: 6 | Compilation of interesting resources to help you learn Power Platform ALM concep… |
    | [PowerAutomate.Desktop.Modules](jfevia_powerautomate.desktop.modules.md) | C# | :star: 6 | Power Automate extensibility for desktop flows. |
    ...
    | [azure-func-cds-mi](sergeytunnik_azure-func-cds-mi.md) | C# | :star: 6 | Basic template for using Dynamics\CDS\Dataverse client with Managed Identity aut… |
    | [LoopbackDataProvider](fowl2_loopbackdataprovider.md) | C# | :star: 6 | A custom Microsoft Dataverse Virtual Table Data Provider plugin that mirrors/loo… |
    | [Dynamics365.Tools](zooy_dynamics365.tools.md) | C# | :star: 6 | Components and tools for Microsoft Dynamics CRM 2016 / Dynamics 365. |
    | [d365fo-template](vxzry_d365fo-template.md) | PowerShell | :star: 6 | D365 template for Git. Template for D365 FO (Microsoft Dynamics 365 Finance and … |
    | [FieldCreator.TyCorcoran](tcorcor1_fieldcreator.tycorcoran.md) | C# | :star: 6 | XrmToolBox plugin for bulk creating fields via CSV import in Dynamics 365 |
    ...
    | [EditableQuickViewForm](akouddane_editablequickviewform.md) | TypeScript | :star: 6 | Editable QuickView Form in Dynamics CRM |
    | [HandyCrmPS](sergeytunnik_handycrmps.md) | PowerShell | :star: 6 | Set of basic cmdlets for PowerShell. It helps running common routine day-to-day … |
    | [Dynamics365Configuration](shurick81_dynamics365configuration.md) | PowerShell | :star: 6 |  |
    | [PCF-TagCloud](oolashyn_pcf-tagcloud.md) | TypeScript | :star: 6 | Tag Cloud Dataset component using PowerApps Component Framework |
    | [GSA-SAM-Connector](topness-msft_gsa-sam-connector.md) | Unknown | :star: 5 | Power Platform Custom Connector for the GSA SAM API (https://gsa.github.io/sam_a… |
    | [SAP-PowerPlatform-OpenAI-Use-Cases-Presentation](mimergel_sap-powerplatform-openai-use-cases-presentation.md) | Unknown | :star: 5 | This repository contains a power point with high level architecture diagrams and… |
    | [dataverse-capacity](jukkan_dataverse-capacity.md) | JavaScript | :star: 5 | Calculator for the Dataverse capacity you get from different Microsoft product l… |
    ...
    | [business-central-webhooks](msnraju_business-central-webhooks.md) | JavaScript | :star: 5 | Client Application to subscribe Business Central Webhooks |
    | [Dynamics-365-RetrieveMultiple-Plugin-Example](matematuk_dynamics-365-retrievemultiple-plugin-example.md) | C# | :star: 5 | This is a simple examples of Plugin on RetrieveMultiple message. |
    | [microax](it950_microax.md) | Unknown | :star: 5 | Micro ax is an ERP system and learned from microsoft's dynamics 365. we serve th… |
    ...
    | [PowerAutomate-MicrosoftTeamsBufferTime](wortell_powerautomate-microsoftteamsbuffertime.md) | Unknown | :star: 4 | Want some time to breathe after your back to back meetings? |
    | [power-automate-dailystar-prothomalo-epaper2pdf](fahim-ahmed05_power-automate-dailystar-prothomalo-epaper2pdf.md) | PowerShell | :star: 4 | Power Automate flow for converting The Daily Star & Prothom Alo ePaper to PDF |
    | [Microsoft-Power-Automate](zhisonghuo_microsoft-power-automate.md) | Unknown | :star: 4 | A collection of my custom solutions using Microsoft Power Automate for workflow … |
    | [MDEN](depressioncenter_mden.md) | Unknown | :star: 4 | Mobile technologies code from the University of Michigan's Mobile Data Experts N… |
    | [AutomationHelper_plugins](plug1210_automationhelper_plugins.md) | Python | :star: 4 | 🤖 Enhance automation workflows in Power Automate and n8n with AI skills for desi… |
    ...
    | [uplift-contrib](subpointsolutions_uplift-contrib.md) | PowerShell | :star: 4 | Vagrant configs for the uplift project: Windows 2016 domain controllers, SQL 201… |
    | [BCSaturdayCodeHacks](jeffreybulanadi_bcsaturdaycodehacks.md) | AL | :star: 4 | AL development, demystified, transparent samples built for learning. |
    ...
    | [WebResourceManager](gotdibbs_webresourcemanager.md) | C# | :star: 4 | Desktop app to assist with the development lifecycle of web resources in Dynamic… |
    | [bc-performance-tests](msnraju_bc-performance-tests.md) | Perl | :star: 4 | How to solve Table Locking Issues in Business Central |
    | [ShowLatestNews](takayakawano_showlatestnews.md) | JavaScript | :star: 4 | This solution is showing the latest news of cutomer in a form of CRM using by Bi… |
    | [Fluent-Power-Apps-components-Starter](duanshaolong_fluent-power-apps-components-starter.md) | TypeScript | :star: 4 | Use of React and Office UI Fabric React in the PowerApps component framework |
    | [msal-react-user-lookup-pcf](taerimhan_msal-react-user-lookup-pcf.md) | TypeScript | :star: 4 | Sample PCF control calling Microsoft Graph using @azure/msal-react |
    ...
    | [powershell-modules](zerg00s_powershell-modules.md) | JavaScript | :star: 3 | PowerShell Modules Guide for Busy Microsoft 365 Consultants |
    ...
    | [azure-functions-oauth-1.0](elliott-liu_azure-functions-oauth-1.0.md) | PowerShell | :star: 3 | Azure Functions script to create an OAuth 1.0 Authorization header. Intended to … |
    | [Power_BI](tadeshee_power_bi.md) | Unknown | :star: 3 | This repository showcases a Power BI project integrating data from diverse sourc… |
    | [InPathPivot](ipd-azure-challenge_inpathpivot.md) | HTML | :star: 3 | An easy to use PWA Technology training/career platform for under served groups i… |
    | [cryptoAPI](gbaeke_cryptoapi.md) | Go | :star: 3 | Simple REST API with goa for use with PowerApps |
    ...
    | [data-processing-api](quangxuan98765_data-processing-api.md) | C# | :star: 3 | ASP.NET Core Web API for Excel Data Processing & Bulk Database Operations |
    | [token-proxy](talxis_token-proxy.md) | C# | :star: 3 | Token Proxy allows the use of client_credentials grant in Logic Apps/Power Autom… |
    | [D365.Model.Generator](aymericm78_d365.model.generator.md) | C# | :star: 3 | Late bound classes generator with D365 CRM data model |
    | [hubspot-integrator-for-dynamics-365](novalogica_hubspot-integrator-for-dynamics-365.md) | Unknown | :star: 3 | The HubSpot Integrator for Dynamics 365 is a powerful and flexible integration s… |
    | [dataverse-helper](dvla_dataverse-helper.md) | Ruby | :star: 3 | This gem helps you integrate with Microsoft Dynamics using Microsoft Dataverse W… |
    | [dataverse](primno_dataverse.md) | TypeScript | :star: 3 | Dataverse / Dynamics 365 client for Node.JS |
    | [fake-xrm-easy-plugins](dynamicsvalue_fake-xrm-easy-plugins.md) | C# | :star: 3 | FakeXrmEasy.Plugins project extends FakeXrmEasy with mocking helpers for Dynamic… |
    | [Dataverse](cooptimize_dataverse.md) | TSQL | :star: 3 | Tools and samples to help reporting from Dataverse. Primarily focused on Data La… |
    | [pcd.dataverso.org](jornalistainclusivo_pcd.dataverso.org.md) | SCSS | :star: 3 | Site da Dataverso PcD |
    | [MSFT-Power-Platform](haithems_msft-power-platform.md) | HTML | :star: 3 | This repository focuses on Microsoft Power Platform-related work, providing tool… |
    | [Utilities365](ramarao9_utilities365.md) | TypeScript | :star: 3 | A cross platform desktop tool which provides a quicker and easier way to perform… |
    ...
    | [Power-Automate-Utility-Flows](essexenergy_power-automate-utility-flows.md) | Unknown | :star: 2 | The purpose of this solution is to provide general Power Automate flows for acti… |
    | [PowerAutomate-Get-Data-Source-List-Info](kkazala_powerautomate-get-data-source-list-info.md) | Unknown | :star: 2 | A flow to retrieve list information (title, url, driveId) for use with Power Aut… |
    ...
    | [power-platform-playbook](kimtth_power-platform-playbook.md) | Unknown | :star: 2 | 🤖⚙️🔧🦾👩‍💻💻Power BI, Power Apps, Power Automate, and Power Virtual Agents, AI Buil… |
    ...
    | [PowerApps](toashishagarwal-zz_powerapps.md) | Unknown | :star: 2 | MeerKat, a mobile app for referring and tracking employee referrals |
    | [power-tools.github.io](power-tools_power-tools.github.io.md) | Unknown | :star: 2 | The PowerTools GitHub Page |
    ...
    | [Drm.Schemas](jetsetwilly1_drm.schemas.md) | Unknown | :star: 2 | Schemas used as part of the DRM Templates tool |
    | [dataverse-analysis](maastrichtu-library_dataverse-analysis.md) | Jupyter Notebook | :star: 2 | 🚦Python script to analyze, visualize and generate reports on DataverseNL admin d… |
    ...
    | [App-Builder](justm3sunny_app-builder.md) | JavaScript | :star: 2 | An intuitive AI-powered code sandbox builder built with React, TailwindCSS, and … |
    ...
    | [dataverse-client-factory](emerbrito_dataverse-client-factory.md) | C# | :star: 1 | The DataverseClientFactory helps minimize the cost of opening or cloning Dataver… |
    | [PowerPlatform-Community-Bangladesh](manakib_powerplatform-community-bangladesh.md) | Unknown | :star: 1 | Microsoft Flow Automation Meeting request approval.  |
    | [genai-cloudops-automation-bot](intelliconnect_genai-cloudops-automation-bot.md) | Unknown | :star: 1 | GenerativeAI CloudOps Automation Powered ByMS Co-Pilot, Power Automate, Power Ap… |
    | [icon-365](jukkan_icon-365.md) | TypeScript | :star: 1 | Visual browser for Microsoft Cloud Logos community repo |
    | [PowerPlatformDocumentationTool](nmelancon_powerplatformdocumentationtool.md) | TypeScript | :star: 1 | Local-only desktop app for Windows or MacOS that parses Power Platform export ar… |
    | [Check-Vehicle](adalbertpungu_check-vehicle.md) | Unknown | :star: 1 | Let's automate the vehicle identification with the Check Vehicle solution which … |
    | [Power-Automate-Get-Teams-Channel-Library-Info](kkazala_power-automate-get-teams-channel-library-info.md) | Unknown | :star: 1 | Power Automate workflow retrieving SPO library and folder information based on t… |
    | [Animals-Shelter-Home-Power-Up-Challange](mahmoud2abdallah_animals-shelter-home-power-up-challange.md) | Unknown | :star: 1 | The Microsoft Power Up Challenge involves importing data from resources into the… |
    | [SolutionPackager-PowerShell](paulbreuler_solutionpackager-powershell.md) | PowerShell | :star: 1 | SolutionPackager PowerShell module developed to improve command line ease of use… |
    | [BlazorStandaloneAADExample](mohsinonxrm_blazorstandaloneaadexample.md) | HTML | :star: 1 | A Multi-Tenant Blazor WebAssembly App showing connectivity with Global Discovery… |
    | [playwrightOnPowerPlatform](itweedie_playwrightonpowerplatform.md) | TypeScript | :star: 1 | This is a template repository for getting started with Playwright on the Power P… |
    | [pcf-fluent-year-picker](nunosubtil_pcf-fluent-year-picker.md) | TypeScript | :star: 1 | Fluent Year Picker PCF Component |
    | [PL-200](josepapitha_pl-200.md) | Unknown | :star: 1 | User guide to clear Microsoft Power Platform Functional Consultant Exam (PL-200)… |
    | [PCF-DateTimeYearOnly](jacobtonder_pcf-datetimeyearonly.md) | TypeScript | :star: 1 |  |
    ...
    | [PowerDreller](dreller_powerdreller.md) | Unknown | :star: 1 | The PowerDreller Component Library for Power Apps. |
    | [student-application-process](sam-404_student-application-process.md) | Unknown | :star: 1 | This application is built for prospective students at a university/college. It a… |
    ...
    | [Loan-Application-Process-Digitisation-](bhuvanachandriga-sivanandam_loan-application-process-digitisation-.md) | Unknown | :star: 1 | using Power Systems- A fully connected digital process: Customer Form → Automati… |
    | [Recordatio](uwlsimulationcentre_recordatio.md) | Unknown | :star: 1 | Application to mark timings for OSCE Exams for future editing |
    | [SignInToAppOnly](jianxu42_signintoapponly.md) | C# | :star: 1 | No, sign in to this app only |
    | [PDF-Viewer-PCF](sahib-sawhney-wh_pdf-viewer-pcf.md) | TypeScript | :star: 1 | Custom PDF viewer PCF control. |
    | [D365Practices.PowerApps.PCF](oguzhanakpinar_d365practices.powerapps.pcf.md) | TypeScript | :star: 1 | Sample reactjs powerapps component that customizes boolean fields as switch. |
    | [PowerApps-PowerHeat](carloshm_powerapps-powerheat.md) | TypeScript | :star: 1 | A component to add Microsoft Clarity integration to Power Apps |
    | [mylife365](dominiquedelaire_mylife365.md) | Unknown | :star: 1 | Application Microsoft PowerApps model driven pour gérer votre vie quotidienne pe… |
    | [Power-Apps-Bulk-Editing](zackjohnson22_power-apps-bulk-editing.md) | Unknown | :star: 1 | Sample Power App that is configured to quickly and efficiently modify records wi… |
    | [PowerPlatform_Projects](bharat2022_powerplatform_projects.md) | Unknown | :star: 1 | A collection of enterprise-grade Power Platform solutions including Power Apps, … |
    | [Urban-Haven](adi907_urban-haven.md) | HTML | :star: 1 | A dynamic E-commerce store that enables users to browse, add items to their cart… |
    ...
    | [genai-pm-assistant-smart-reminder](intelliconnect_genai-pm-assistant-smart-reminder.md) | Unknown | :star: 1 | GenAI Powered Smart Reminder for PM-Team Collaboration powered by Microsoft Co-P… |
    | [spo-timetoread](alexc-msft_spo-timetoread.md) | Unknown | :star: 1 | Solution that provides users with an estimated 'Time to Read' for content in Sha… |
    | [Automated_PDF_Data_Processing](psilvautomata_automated_pdf_data_processing.md) | VBA | :star: 1 | Data automation and processing tool designed to streamline the extraction and an… |
    ...
    | [power-automate-connector](reinfer_power-automate-connector.md) | Unknown | :star: 1 | A connector for Re:infer and Power Automate / Azure Logic Apps |
    | [Respiratory-Health-Recommendation-System](abhishek1377_respiratory-health-recommendation-system.md) | Jupyter Notebook | :star: 1 | Respiratory Health Recommendation System based on Air Quality Index Forecasts |
    | [MSFT-365](xeno-systems_msft-365.md) | Unknown | :star: 1 | Files and documentation for MSFT 365 projects. This inludes Teams Help Desk tick… |
    | [image-snippets-generator](rohan-motukuri_image-snippets-generator.md) | JavaScript | :star: 1 | Image extraction from PDF or Image files from the comfort of one's own Google Dr… |
    | [docentric-docusign](docentric_docentric-docusign.md) | Unknown | :star: 1 | Dataverse solution using Power Automate for automated document signing in D365FO… |
    | [Data-Subject-Request-tracker](shadrock_data-subject-request-tracker.md) | Unknown | :star: 1 | Automating workflows for @MercyCorps Data Subject Requests |
    | [vendor-risk-governance-automation](rcalig_vendor-risk-governance-automation.md) | Unknown | :star: 1 | Vendor-agnostic pattern for automating vendor risk governance and translating re… |
    | [node-ms-teams-workflow-webhook](cityssm_node-ms-teams-workflow-webhook.md) | TypeScript | :star: 1 | Sends a formatted message (i.e. Adaptive Card) to a Microsoft Teams workflow web… |
    | [qa-orchestrator-platform](jackyilmaz_qa-orchestrator-platform.md) | Java | :star: 1 | AI-powered QA analysis platform that converts Jira issues into structured testin… |
    ...
    | [DynamicsCrm-NodeCrmService](yagasoft_dynamicscrm-nodecrmservice.md) | TypeScript | :star: 1 | Easily authenticate with Dynamics CRM built-in services from a Node app. |
    | [XrmToolBoxPluginTemplate](mscrmtools_xrmtoolboxplugintemplate.md) | C# | :star: 1 | Visual Studio template to create XrmToolBox plugin |
    | [DynamicsPluginC-](matiassolisbello_dynamicspluginc-.md) | C# | :star: 1 | :white_check_mark: First Plug-in for CRM Dynamics 365 |
    | [Twitter-Social-Talk-for-an-Organization-using-Dynamics-365](abhirajpr_twitter-social-talk-for-an-organization-using-dynamics-365.md) | HTML | :star: 1 |  |
    | [RetrieveIoTSensorData](takayakawano_retrieveiotsensordata.md) | Unknown | :star: 1 | This is for retrieve IoT Sensor data in Document DB from Dynamics CRM Plugin. |
    ...
    | [PowerApps-Portal-Carousel-](rkadey_powerapps-portal-carousel-.md) | HTML | :star: 0 |  |
    | [PAProcMon](appliedtechnologies_paprocmon.md) | Unknown | :star: 0 | a tool for the automated monitoring of Microsoft Power Automate Flows 🔍 |
    | [CFTIC-Pl900-Microsoft_Power_Platform_Fundamentals](adrianarenilla_cftic-pl900-microsoft_power_platform_fundamentals.md) | Unknown | :star: 0 | Evidence of Adrian Arenilla Seco's CFTIC course practices. |
    | [canvas-power-platform](jessicacosta07_canvas-power-platform.md) | Unknown | :star: 0 | Programação C# com CRM Dynamics - Digital Innovation One (DIO) |
    | [dataverse-client-messaging](emerbrito_dataverse-client-messaging.md) | C# | :star: 0 | Azure functions service bus message handler. |
    | [DespachosAlmacen](fradurgo19_despachosalmacen.md) | Unknown | :star: 0 | Power apps Optimiza y simplifica la gestión de despachos desde los almacenes con… |
    | [Types-of-PowerApps](eccentrix-ca_types-of-powerapps.md) | Unknown | :star: 0 | PowerApps categorizes applications into three primary types, each serving distin… |
    | [codebug-dataverse-nest-mcp](imrancodebug_codebug-dataverse-nest-mcp.md) | TypeScript | :star: 0 | NestJS-based MCP server that integrates with Microsoft Dataverse to retrieve cus… |
    ...
    | [power-platform-recruitmentvn-solution](tonyh0401_power-platform-recruitmentvn-solution.md) | Unknown | :star: 0 | Version Control Power Platform "RecruitmentVN" Solution using Export Manually Me… |
    | [pcf-hybrid-sccontact-scaccount-management-control](tonyh0401_pcf-hybrid-sccontact-scaccount-management-control.md) | TypeScript | :star: 0 | A hybrid PCF control with FluentUI for managing SCContact & SCAccount relationsh… |
    ...
    | [Library-Management-Database-App](omkardabholkar_library-management-database-app.md) | Unknown | :star: 0 | Developed a cloud-based Library Management Database App utilizing Azure Databric… |
    ...
    | [PowerApps-AIADDemoAccounts](toanan_powerapps-aiaddemoaccounts.md) | Unknown | :star: 0 | Power Apps : Store and distribute demonstration account based on meeting attende… |
    | [ShopVista](muhammad-umer-wasi_shopvista.md) | Unknown | :star: 0 | Powerapp Canvas App Shop Vista: Elevate customer experiences through an intuitiv… |
    | [PECO_Internship](jdtumlinson_peco_internship.md) | Python | :star: 0 | Collection of images related to internship at Astronics-PECO. March-September 20… |
    | [sharepoint-stuff](laffchem_sharepoint-stuff.md) | Unknown | :star: 0 | Just a collection of things I use for work, easier than saving a ton of bookmark… |
    | [Task-List-App-Power-Apps](karlyndiary_task-list-app-power-apps.md) | Unknown | :star: 0 | Task List App created using Power Apps |
    | [Fabio_Castilho](fabionc1711_fabio_castilho.md) | Unknown | :star: 0 |  |
    | [WORKFORCE-MANAGEMENT-OPTIMIZATION-POWER-BI](rgandhi8_workforce-management-optimization-power-bi.md) | Unknown | :star: 0 | Developed an HR Analytics Dashboard for ATLIQ using Power BI, DAX, Power Query, … |
    | [appmentor](tommy1003_appmentor.md) | Unknown | :star: 0 | Code for community 🌏 |
    | [activereportsjs-powerapps-2](mesciusjp_activereportsjs-powerapps-2.md) | Unknown | :star: 0 | Create a reports application in the Power Apps canvas app using ActiveReportsJS. |
    | [Library-Manager-Canvas-App](mahmoud2abdallah_library-manager-canvas-app.md) | Unknown | :star: 0 | Library Loans Manager App Merging between Model driven app and Canvas one in Lib… |
    | [Power-Apps-Rounding](roboest_power-apps-rounding.md) | C# | :star: 0 | A simple unbound action plugin to allow rounding decimals in Power Automate |
    | [patrol-app](ppkhoa_patrol-app.md) | Unknown | :star: 0 | App phục vụ công việc tuần tra an ninh tại các địa điểm được đặt trước, đảm bảo … |
    | [MSA-P3](taizoku_msa-p3.md) | Unknown | :star: 0 | Power Apps project for MSA |
    | [Power-Platform_model-driven-apps](jpdosher_power-platform_model-driven-apps.md) | JavaScript | :star: 0 | Model-driven apps in Power Platform are applications that are created by adding … |
    | [HiddenSortGrid](bendi-dynamix_hiddensortgrid.md) | TypeScript | :star: 0 | Switchable readonly/editable PCF OOB-like subgrid with optional sorting, filters… |
    ...
    | [veterinario](matheusforstner_veterinario.md) | Unknown | :star: 0 | Criação no aplicativo de Veterinário em C# e PowerApps |
    | [AppControlVehiculos](fradurgo19_appcontrolvehiculos.md) | Unknown | :star: 0 | ¡Bienvenido a la revolución en la gestión vehicular! Descubre nuestra increíble … |
    | [cds-customization-validator](teppolainio_cds-customization-validator.md) | C# | :star: 0 | Tool which validates that CDS (i.e. Dynamics CRM / Dynamics 365) customizations … |
    | [coding-cheatsheets](jhawksno_coding-cheatsheets.md) | Unknown | :star: 0 | My personal coding cheatsheet repo.  |
    | [Paint-Order-Fulfillment](symbiotyk_paint-order-fulfillment.md) | Unknown | :star: 0 | An application based on the Microsoft Power Apps low-code environment to manage … |
    | [WhosWhoPowerApp](mrautomate33_whoswhopowerapp.md) | Unknown | :star: 0 | Looking for a college? This app helps you find your colleague. |
    | [AniEasyJs](techwithanirudh_anieasyjs.md) | JavaScript | :star: 0 | A JavaScript library that has power apps functions. |
    | [PowerAppsAIDemos](ppiova_powerappsaidemos.md) | Unknown | :star: 0 | POC application showing capabilities of cognitive services and AI Builder Also u… |
    ...
    | [Manifest](taracts_manifest.md) | Unknown | :star: 0 | Repository of videos, apps, and resources for engaging with  the Microsoft Power… |
    ...
    | [Volkswagen-IT-Engineer](ludanielpoyu_volkswagen-it-engineer.md) | Unknown | :star: 0 | Spring Boot CRM “Recharge” refactor (indexes/pagination/async/caching), Power Au… |
    | [automate_PowerAutomateFlowTest](joshua-probst_automate_powerautomateflowtest.md) | PowerShell | :star: 0 | A short example how you can automate your flow test in power automate with the c… |
    ...
    | [dyn365](philippedemontreal_dyn365.md) | TypeScript | :star: 0 |  |
    ...
    | [I-S_Steel_Dyn365_DevBuild_KM_IS-K3712000B.1_Pilot_2](aninnosolutions_i-s_steel_dyn365_devbuild_km_is-k3712000b.1_pilot_2.md) | Unknown | :star: 0 | I|S Steel - for steel producing/processing companies! is a Microsoft Dynamics 36… |
    ...
    | [D365.Data.Helper](ulaserkus_d365.data.helper.md) | C# | :star: 0 | @D365.Data.Helper DLL |
    | [Alfred.mcp](h22fred_alfred.mcp.md) | TypeScript | :star: 0 | ▎ 🤖 The AI assistant that runs your CRM so you don't have to. Connect Claude Des… |
    | [CrmTestEmailSender](arsentd_crmtestemailsender.md) | C# | :star: 0 | Sends email message from one CRM user to another users. Works for Microsoft Dyna… |
