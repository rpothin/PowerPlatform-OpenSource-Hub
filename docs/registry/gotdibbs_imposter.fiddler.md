...
<section class="mdx-detail-hero">
  <h1>Imposter.Fiddler</h1>
  <p class="mdx-detail-hero__description">Fiddler Extension Version of Imposter</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/gotdibbs/Imposter.Fiddler" class="md-button md-button--primary" target="_blank" rel="noopener">
