...
<section class="mdx-detail-hero">
  <h1>PowerPlatform-DataverseModelBuilder</h1>
  <p class="mdx-detail-hero__description">Code Replica for the Microsoft Power Platform Dataverse Model Builder and supporting nuget packages</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/PowerPlatform-DataverseModelBuilder" class="md-button md-button--primary" target="_blank" rel="noopener">
