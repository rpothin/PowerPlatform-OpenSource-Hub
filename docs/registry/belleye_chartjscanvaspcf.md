...
<section class="mdx-detail-hero">
  <h1>ChartJsCanvasPCF</h1>
  <p class="mdx-detail-hero__description">Chart JS in PowerApps</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Belleye/ChartJsCanvasPCF" class="md-button md-button--primary" target="_blank" rel="noopener">
