...
<section class="mdx-detail-hero">
  <h1>Minimal-React-PCF</h1>
  <p class="mdx-detail-hero__description">A minimal React based PowerApps Control Framework (PCF) template </p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/paulbreuler/Minimal-React-PCF" class="md-button md-button--primary" target="_blank" rel="noopener">
