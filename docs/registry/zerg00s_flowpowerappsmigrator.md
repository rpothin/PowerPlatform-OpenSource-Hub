...
<section class="mdx-detail-hero">
  <h1>FlowPowerAppsMigrator</h1>
  <p class="mdx-detail-hero__description">Converts SharePoint Data sources for the MS Flow and PowerApps to a new tenant of your choice.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/Zerg00s/FlowPowerAppsMigrator" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 156</div>
