...
<section class="mdx-detail-hero">
  <h1>Dynamics365-MetaDataExplorer</h1>
  <p class="mdx-detail-hero__description">Explore, validate and visualize Metadata of a "Microsoft Dynamics 365 for Operations" packages folder</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/AXbusiness/Dynamics365-MetaDataExplorer" class="md-button md-button--primary" target="_blank" rel="noopener">
