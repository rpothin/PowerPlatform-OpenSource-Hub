...
<section class="mdx-detail-hero">
  <h1>PowerPlatformAdvocates</h1>
  <p class="mdx-detail-hero__description">This repository contains presentations and workshops created by the Microsoft Power Platform Advocates.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/PowerPlatformAdvocates" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 186</div>
