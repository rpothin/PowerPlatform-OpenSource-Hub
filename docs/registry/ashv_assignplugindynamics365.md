...
<section class="mdx-detail-hero">
  <h1>AssignPluginDynamics365</h1>
  <p class="mdx-detail-hero__description">Assigning Case to Appropriate Team User Using Plugin in Dynamics CRM / 365</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/AshV/AssignPluginDynamics365" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Updated 2022-08-08</span>
    <span><a href="http://www.c-sharpcorner.com/article/assigning-case-to-appropriate-team-user-using-plugin-in-dynamics-365-crm/" target="_blank" rel="noopener">http://www.c-sharpcorner.com/article/assigning-case-to-appropriate-team-user-using-plugin-in-dynamics-365-crm/</a></span>
  </div>
</section>
