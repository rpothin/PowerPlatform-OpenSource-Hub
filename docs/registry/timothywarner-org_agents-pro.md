...
<section class="mdx-detail-hero">
  <h1>agents-pro</h1>
  <p class="mdx-detail-hero__description">Teaching/learning resources for O'Reilly Live 'How to Create AI Agents Like a Pro': Microsoft Copilot Studio builds for customer service, onboarding, and document automation.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/timothywarner-org/agents-pro" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    <span>Python</span>
    <span>Other</span>
    <span>Created 2025-12-04</span>
    <span>Updated 2026-03-30</span>
    <span><a href="https://techtrainertim.com" target="_blank" rel="noopener">https://techtrainertim.com</a></span>
  </div>
</section>
