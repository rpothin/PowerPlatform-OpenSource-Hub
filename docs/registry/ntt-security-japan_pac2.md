...
<section class="mdx-detail-hero">
  <h1>pac2</h1>
  <p class="mdx-detail-hero__description">Power Automate C2 (PAC2) :  Stealth living-off-the-cloud C2 framework.</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/NTT-Security-Japan/pac2" class="md-button md-button--primary" target="_blank" rel="noopener">
...
<div class="mdx-detail-stats">
  <div class="mdx-detail-stats__card">
    <div class="mdx-detail-stats__number">⭐ 36</div>
