...
<section class="mdx-detail-hero">
  <h1>PCF-DragAndDropGrid</h1>
  <p class="mdx-detail-hero__description">This control allows to quickly upload Dynamics 365 note attachments by drag and droping it directly on the grid of records</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/BeverCRM/PCF-DragAndDropGrid" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2022-07-20</span>
    <span>Updated 2025-03-02</span>
