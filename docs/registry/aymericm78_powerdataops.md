...
<section class="mdx-detail-hero">
  <h1>PowerDataOps</h1>
  <p class="mdx-detail-hero__description">PowerShell module for Microsoft Dataverse and Power Platform automation (Data Management, administration and DevOps activities)</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/AymericM78/PowerDataOps" class="md-button md-button--primary" target="_blank" rel="noopener">
