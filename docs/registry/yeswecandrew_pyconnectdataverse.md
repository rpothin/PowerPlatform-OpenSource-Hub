...
<section class="mdx-detail-hero">
  <h1>PyConnectDataverse</h1>
  <p class="mdx-detail-hero__description">Connect to the Dynamics 365 / Dataverse Web API using interactive login</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/YesWeCandrew/PyConnectDataverse" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2023-06-26</span>
    <span>Updated 2025-12-30</span>
    <span><a href="https://andyhowes.co/easily-connect-to-dataverse-microsoft-dynamics-with-python/" target="_blank" rel="noopener">https://andyhowes.co/easily-connect-to-dataverse-microsoft-dynamics-with-python/</a></span>
  </div>
</section>
