...
<section class="mdx-detail-hero">
  <h1>Power-Platform-App-Dev-in-a-Day-KR</h1>
  <p class="mdx-detail-hero__description">Power Platform Hands-on-Lab sessions repository in Korean</p>
  <div class="mdx-detail-hero__actions">
    <a href="https://github.com/microsoft/Power-Platform-App-Dev-in-a-Day-KR" class="md-button md-button--primary" target="_blank" rel="noopener">
  ...
  <div class="mdx-detail-hero__meta">
    ...
    <span>Created 2023-01-08</span>
    <span>Updated 2025-10-06</span>
    <span><a href="https://aka.ms/gppbkr/appdev-in-a-day" target="_blank" rel="noopener">https://aka.ms/gppbkr/appdev-in-a-day</a></span>
  </div>
</section>
